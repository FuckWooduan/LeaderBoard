...
public class AVM2GraphSource extends GraphSource {
    ...
    public AVM2GraphSource(
            ...
            HashMap<Integer, String> localRegNames,
            List<DottedChain> fullyQualifiedNames,
            HashMap<Integer, Integer> localRegAssignmentIp) {
        this.code = code;
    ...
    public void translatePart(
        ...
        code.toSourceOutput(
                localData.maxTempIndex,
                output,
                localData.swfVersion,
                ((AVM2LocalData) localData).callStack,
                ((AVM2LocalData) localData).abcIndex,
                ((AVM2LocalData) localData).setLocalPosToGetLocalPos,
                ((AVM2LocalData) localData).thisHasDefaultToPrimitive,
                lineStartItem,
                path,
                part,
                false,
                ...
                localRegs,
                stack,
                ((AVM2LocalData) localData).scopeStack,
                ((AVM2LocalData) localData).localScopeStack,
                abc,
                body,
                start,
                end,
                localRegNames,
                ((AVM2LocalData) localData).localRegTypes,
                fullyQualifiedNames,
                new boolean[size()],
