...
public final class FlasmLexer {
    ...
    private static final String ZZ_CMAP_PACKED =
            "\11\6\1\4\1\2\1\51\1\52\1\1\16\6\4\0\1\4\1\0" + "\1\43\1\0\1\5\2\0\1\47\3\0\1\35\1\44\1\25\1\33"
    ...
    private static final String ZZ_ACTION_PACKED_0 =
            "\3\0\2\1\1\2\1\3\1\4\2\5\1\1\1\6" + "\2\7\1\10\1\11\1\12\5\11\1\1\1\11\2\13"
    ...
    private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\54\0\130\0\204\0\260\0\334\0\204\0\204"
    ...
    private static final String ZZ_TRANS_PACKED_0 =
            "\4\4\1\5\1\6\3\4\1\7\13\6\1\4\2\6" + "\2\4\1\6\1\4\1\6\1\4\1\6\1\4\3\6"
    ...
    private static final String ZZ_ATTRIBUTE_PACKED_0 =
            "\3\0\1\11\2\1\2\11\1\1\1\11\1\1\1\11" + "\1\1\1\11\2\1\1\11\14\1\4\11\1\1\2\11"
        ...
        while (true) {
            ...
            switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
                ...
                case 58:
                    break;
                case 25: {
                    return new ASMParsedSymbol(
                            yychar(),
                            ASMParsedSymbol.TYPE_FLOAT,
                            Float.parseFloat(yytext().substring(0, yytext().length() - 1)));
                }
                case 59:
                    break;
                case 26: {
                ...
                case 32: {
                    return new ASMParsedSymbol(
                            yychar(),
                            ASMParsedSymbol.TYPE_REGISTER,
                            new RegisterNumber(Integer.parseInt(yytext().substring(8))));
                }
                case 66:
                    break;
                case 33: {
                ...
                case 34: {
                    return new ASMParsedSymbol(
                            yychar(),
                            ASMParsedSymbol.TYPE_CONSTANT,
                            new ConstantIndex(Integer.parseInt(yytext().substring(8))));
                }
                case 68:
                    break;
                default:
