...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.exporters.ImageTagBufferedImage;
...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.exporters.shape.aa.AntialiasedBitmapExporter;
...
import com.strikegod.engine.ffdec.jpexs.graphics.ExtendedBasicStroke;
...
public class BitmapExporter extends ShapeExporterBase {
    ...
    public static void export(
            ...
            int aaScale) {
        if (aaScale > 1) {
            AntialiasedBitmapExporter.export(
                    windingRule,
                    shapeNum,
                    swf,
                    shape,
            ...
            BitmapExporter exporter =
                    new BitmapExporter(windingRule, shapeNum, swf, shape, defaultColor, colorTransform);
    ...
    protected BitmapExporter(
            int windingRule, int shapeNum, SWF swf, SHAPE shape, Color defaultColor, ColorTransform colorTransform) {
        super(windingRule, shapeNum, swf, shape, colorTransform);
        this.swf = swf;
        this.defaultColor = defaultColor;
        path = new GeneralPath(
                windingRule == ShapeTag.WIND_NONZERO ? GeneralPath.WIND_NON_ZERO : GeneralPath.WIND_EVEN_ODD);
    }

    protected void exportTo(
            int shapeNum,
            SerializableImage image,
            double unzoom,
            Matrix transformation,
    ...
    protected void calculateThicknessScale() {
        com.strikegod.engine.ffdec.jpexs.decompiler.flash.exporters.commonshape.Point p00 =
                strokeTransformation.transform(0, 0);
        com.strikegod.engine.ffdec.jpexs.decompiler.flash.exporters.commonshape.Point p11 =
                strokeTransformation.transform(1, 1);
        ...
        switch (type) {
            case FILLSTYLE.LINEAR_GRADIENT:
                fillPaint = new LinearGradientPaint(
                        POINT_NEG16384_0, POINT_16384_0, ratiosArr, colorsArr, cm, cstype, IDENTITY_TRANSFORM);
                break;
            ...
            case FILLSTYLE.FOCAL_RADIAL_GRADIENT:
                fillPaint = new RadialGradientPaint(
                        new java.awt.Point(0, 0),
                        16384,
                        new java.awt.Point((int) (focalPointRatio * 16384), 0),
                        ratiosArr,
                        colorsArr,
                        cm,
                        cstype,
    ...
    public void lineStyle(
        ...
        if (joinStyle == BasicStroke.JOIN_MITER) {
            lineStroke = new ExtendedBasicStroke(
                    (float) thickness, capStyle, ExtendedBasicStroke.JOIN_MITER_CLIP, miterLimit);
        } else {
        ...
        try {
            AffineTransform t =
                    (AffineTransform) strokeTransformation.toTransform().clone();
    ...
    public void lineGradientStyle(
        ...
        switch (type) {
            ...
            case FILLSTYLE.RADIAL_GRADIENT:
                ...
                break;
            case FILLSTYLE.FOCAL_RADIAL_GRADIENT:
                linePaint = new RadialGradientPaint(
                        new java.awt.Point(0, 0),
                        16384,
                        new java.awt.Point((int) (focalPointRatio * 16384), 0),
                        ratiosArr,
    ...
    public void lineBitmapStyle(
        ...
        if (imageTag != null) {
            ...
            if (img != null) {
                ...
                linePaint = new TexturePaint(
                        img.getBufferedImage(), new java.awt.Rectangle(img.getWidth(), img.getHeight()));
                lineTransform = matrix.toTransform();
                return;
            }
        }
        ...
        if (fillPaint != null) {
            ...
            if (fillPaint instanceof MultipleGradientPaint) {
                ...
                if (inverse != null) {
                    ...
                    graphics.fill(new java.awt.Rectangle(
                            (int) minX, (int) minY, (int) (rect.xMax - minX), (int) (rect.yMax - minY)));
                }
                ...
                if (fillRepeat) {
                    ...
                    if (inverse != null) {
                        ...
                        // left
                        graphics.drawImage(
                                ((TexturePaint) fillPaint).getImage(),
                                (int) rect.xMin,
                                0,
                                0,
                        ...
                        graphics.drawImage(
                                ...
                                0,
                                (int) rect.yMin,
                                ((TexturePaint) fillPaint).getImage().getWidth(),
                                0,
                                0,
                                0,
                                ((TexturePaint) fillPaint).getImage().getWidth(),
                        ...
                        graphics.drawImage(
                                ...
                                (int) rect.xMax,
                                0,
                                ((TexturePaint) fillPaint).getImage().getWidth() - 1,
                                0,
                                ((TexturePaint) fillPaint).getImage().getWidth(),
                                1,
                                null);
                        ...
                        graphics.drawImage(
                                ...
                                (int) rect.yMax,
                                ((TexturePaint) fillPaint).getImage().getWidth() - 1,
                                ((TexturePaint) fillPaint).getImage().getHeight() - 1,
                                ((TexturePaint) fillPaint).getImage().getWidth(),
                                ((TexturePaint) fillPaint).getImage().getHeight(),
                                null);
                        // bottom
        ...
        if (linePaint != null && lineStroke != null) {
            ...
            if (linePaint instanceof MultipleGradientPaint) {
                ...
                if (inverse != null) {
                    ...
                    double minY = rect.yMin;
                    graphics.fill(
                            new Rectangle((int) minX, (int) minY, (int) (rect.xMax - minX), (int) (rect.yMax - minY)));
                }
