 ...
 */
package com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.converters;
...
public class PlaceObjectTypeConverter {
     ...
     */
    public PlaceObjectTypeTag convertTagType(
            PlaceObjectTypeTag sourcePlaceTag, SWF targetSWF, int targetPlaceNum, boolean deepClone) {
        ...
        switch (targetPlaceNum) {
            case 1:
                ...
                if (colorTransform != null) {
                    place1.colorTransform = !deepClone && colorTransform.getClass() == CXFORM.class
                            ? (CXFORM) colorTransform
                            : new CXFORM(colorTransform);
                }
            ...
            case 2:
                ...
                if (colorTransform != null) {
                    place2.colorTransform = !deepClone && colorTransform.getClass() == CXFORMWITHALPHA.class
                            ? (CXFORMWITHALPHA) colorTransform
                            : new CXFORMWITHALPHA(colorTransform);
            ...
            case 3:
                ...
                if (colorTransform != null) {
                    place3.colorTransform = !deepClone && colorTransform.getClass() == CXFORMWITHALPHA.class
                            ? (CXFORMWITHALPHA) colorTransform
                            : new CXFORMWITHALPHA(colorTransform);
            ...
            case 4:
                ...
                if (colorTransform != null) {
                    place4.colorTransform = !deepClone && colorTransform.getClass() == CXFORMWITHALPHA.class
                            ? (CXFORMWITHALPHA) colorTransform
                            : new CXFORMWITHALPHA(colorTransform);
