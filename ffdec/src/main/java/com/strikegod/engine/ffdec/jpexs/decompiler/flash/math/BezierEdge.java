...
public class BezierEdge implements Serializable {
    ...
    public List<Point2D> getIntersections(BezierEdge b2) {
        ...
        if (points.size() == 2) {
            if (b2.points.size() == 2) {
                return Intersections.intersectLineLine(
                        points.get(0), points.get(1), b2.points.get(0), b2.points.get(1), true);
            } else {
                return Intersections.intersectBezier2Line(
                        b2.points.get(0), b2.points.get(1), b2.points.get(2), points.get(0), points.get(1));
            }
        } else {
            if (b2.points.size() == 2) {
                return Intersections.intersectBezier2Line(
                        points.get(0), points.get(1), points.get(2), b2.points.get(0), b2.points.get(1));
            } else {
                return Intersections.intersectBezier2Bezier2(
                        points.get(0),
                        points.get(1),
                        points.get(2),
                        b2.points.get(0),
    ...
    public boolean intersectsOld(BezierEdge b2, List<Double> t1Ref, List<Double> t2Ref) {
        ...
        boolean ret = intersects(b2, 0, 1, 0, 1, t1RefA, t2RefA, interPoints);
    ...
    public Double findXCriticalT() {
        ...
        final double a = (points.get(2).getX()
                - 2.0 * points.get(1).getX()
                + points.get(0).getX()); // coefficient of t
    ...
    public double yAt(double x) {
        ...
        // quad
        final double A = (points.get(0).getX()
                - 2.0 * points.get(1).getX()
                + points.get(2).getX());
