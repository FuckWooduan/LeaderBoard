...
public abstract class GraphTextWriter {
     ...
     */
    public GraphTextWriter startOffset(
     ...
     * @return GraphTextWriter
     */
    public final GraphTextWriter hilightSpecial(
            String text, HighlightSpecialType type, int specialValue, HighlightData data) {
     ...
     * @return GraphTextWriter
     */
    protected GraphTextWriter hilightSpecial(
