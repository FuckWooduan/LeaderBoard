...
public class IndexAVM2Item extends AssignableAVM2Item {
    ...
    public List<GraphSourceItem> toSourceChange(
        ...
        int indexPropIndex = g.abcIndex
                .getSelectedAbc()
                .constants
                .getMultinameId(Multiname.createMultinameL(attr, allNsSet(g.abcIndex)), true);
        ...
        return toSourceMerge(
                ...
                index,
                dupSetTemp(localData, generator, index_temp),
        ...
        if (assignedValue != null) {
            ...
            if (assignedValue instanceof CompoundableBinaryOp) {
                ...
                if (comp.getLeftSide() instanceof IndexAVM2Item) {
                    ...
                    if (left.assignedValue == null
                            && Objects.equals(left.object, object)
                            && Objects.equals(left.index, index)
                            && index.hasSideEffect()) {
                        Reference<Integer> val_temp = new Reference<>(-1);
                        Reference<Integer> index_temp = new Reference<>(-1);
                        return toSourceMerge(
