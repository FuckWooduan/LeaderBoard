...
import com.strikegod.engine.ffdec.jpexs.decompiler.graph.model.UnboundedTypeItem;
...
public class CoerceAVM2Item extends AVM2Item {
    ...
    public CoerceAVM2Item(
            GraphSourceItem instruction, GraphSourceItem lineStartIns, GraphTargetItem value, GraphTargetItem typeObj) {
    ...
    public GraphTextWriter appendTo(GraphTextWriter writer, LocalData localData) throws InterruptedException {
        ...
        switch (typeObj.toString()) {
            ...
            case "Boolean":
                displayCoerce =
                        !valueReturnType.equals(TypeItem.BOOLEAN); // && !valueReturnType.equals(TypeItem.UNBOUNDED);
                break;
            case "Number":
    ...
    public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData, SourceGenerator generator)
        ...
        switch (typeObj.toString()) {
            ...
            default:
                int type_index =
                        AVM2SourceGenerator.resolveType(localData, typeObj, ((AVM2SourceGenerator) generator).abcIndex);
