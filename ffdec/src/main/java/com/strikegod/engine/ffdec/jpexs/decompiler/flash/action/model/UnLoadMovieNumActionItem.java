    ...
    private List<GraphSourceItem> toSource(
        ...
        if ((num instanceof DirectValueActionItem) && (((DirectValueActionItem) num).value instanceof Long)) {
            return toSourceMerge(
                    localData,
                    generator,
                    new ActionGetURL("", "_level" + ((DirectValueActionItem) num).value, charset),
                    needsReturn
            ...
            return toSourceMerge(
                    localData,
                    generator,
                    new ActionPush("", charset),
                    new StringAddActionItem(
                            getSrc(), getLineStartItem(), asGenerator.pushConstTargetItem("_level"), num),
