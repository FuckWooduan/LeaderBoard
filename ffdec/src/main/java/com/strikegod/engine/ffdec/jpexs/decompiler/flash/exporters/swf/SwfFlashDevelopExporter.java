...
public class SwfFlashDevelopExporter {
     ...
     */
    public void exportFlashDevelopProject(SWF swf, File outFile, boolean air, AbortRetryIgnoreHandler handler)
            throws IOException {
     ...
     * @throws IOException On I/O error
     */
    public void exportFlashDevelopProject(
            SWF swf, File outFile, boolean air, AbortRetryIgnoreHandler handler, EventListener eventListener)
            throws IOException {
        if (!swf.isAS3()) {
        ...
        if (air) {
            ...
            project = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                    ...
                    + "    <movie platform=\"AIR\" />\n"
                    + "    <movie background=\""
                    + (bgColorTag == null ? "#FFFFFF" : bgColorTag.backgroundColor.toHexRGB()) + "\" />\n"
                    + "    <movie preferredSDK=\"\" />\n"
                    + "  </output>\n"
        ...
        if (air) {
            ...
            try (FileOutputStream fos = new FileOutputStream(
                    outFile.toPath().getParent().resolve("application.xml").toFile())) {
            ...
            String[] batFiles = new String[] {
                "CreateCertificate.bat", "PackageApp.bat", "Packager.bat", "RunApp.bat", "SetupApp.bat", "SetupSDK.bat"
            };
            for (String batFile : batFiles) {
                InputStream is = SwfFlashDevelopExporter.class.getResourceAsStream(
                        "/com/strikegod/engine/ffdec/jpexs/helpers/resource/fd_air/bat/" + batFile);
                ...
                try (FileOutputStream fos =
                        new FileOutputStream(batDirPath.resolve(batFile).toFile())) {
        ...
        ScriptExportSettings scriptExportSettings = new ScriptExportSettings(
                ScriptExportMode.AS, false, false, true, false, "/_assets/", Configuration.linkAllClasses.get(), false);
        swf.exportActionScript(
                handler,
                outFile.toPath().getParent().resolve(srcPath).toFile().getAbsolutePath(),
