...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.abc.avm2.model.UnparsedAVM2Item;
...
public class NewClassIns extends InstructionDefinition {
    ...
    public void translate(
        ...
        stack.push(new UnparsedAVM2Item(
                ins,
                localData.lineStartInstruction,
                "§§newclass("
                        + abc.constants
                                .getMultiname(abc.instance_info.get(clsIndex).name_index)
                                .getName(
                                        localData.usedDeobfuscations,
                                        localData.abc,
