...
public class XFLXmlWriter implements XMLStreamWriter {
    ...
    private void writeStartElementInternal(String prefix, String localName, String namespaceURI)
    ...
    private void writeEmptyElementInternal(String prefix, String localName, String namespaceURI)
            throws XMLStreamException {
