 ...
 * Lesser General Public License for more details.
 */
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.jna.platform.win32.WinNT.HANDLE;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.jna.platform.win32.WinNT.HANDLEByReference;
...
public interface Advapi32 extends StdCallLibrary {
    ...
    public boolean OpenThreadToken(
            HANDLE ThreadHandle, int DesiredAccess, boolean OpenAsSelf, HANDLEByReference TokenHandle);
    ...
    public boolean DuplicateToken(
            HANDLE ExistingTokenHandle, int ImpersonationLevel, HANDLEByReference DuplicateTokenHandle);
