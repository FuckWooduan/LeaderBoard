 ...
 */
package com.strikegod.engine.ffdec.jpexs.decompiler.flash.exporters.morphshape;
...
public class CanvasMorphShapeExporter extends MorphShapeExporterBase {
    ...
    public String getHtml(String needed, String id, RECT rect) {
        ...
        return CanvasShapeExporter.getHtmlPrefix(width, height)
                + getJsPrefix()
                + needed
                + getDrawJs(width, height, id, rect)
                + getJsSuffix(width, height, delayMs, stepRatio)
                + CanvasShapeExporter.getHtmlSuffix();
    }
    ...
    private String getJsSuffix(int width, int height, int delayMs, int stepRatio) {
        ...
        ret.append("}\r\n");
        ret.append("window.setInterval(function(){nextFrame(ctx)},")
                .append(delayMs)
                .append(");\r\n");
    ...
    public void beginFill(RGB color, RGB colorEnd) {
        finalizePath();
        fillData.append("\tctx.fillStyle=")
                .append(useRatioColor(color, colorEnd))
                .append(";\r\n");
    }
    ...
    public void beginGradientFill(
            int type,
            GRADRECORD[] gradientRecords,
            GRADRECORD[] gradientRecordsEnd,
            Matrix matrix,
            Matrix matrixEnd,
            int spreadMethod,
            int interpolationMethod,
            float focalPointRatio,
            float focalPointRatioEnd) {
        finalizePath();
        ...
        if (type == FILLSTYLE.LINEAR_GRADIENT) {
            ...
            fillData.append("\tvar grd=ctx.createLinearGradient(")
                    .append(useRatioPos(start.x, start2.x))
                    .append(",")
                    .append(useRatioPos(start.y, start2.y))
                    .append(",")
                    .append(useRatioPos(end.x, end2.x))
                    .append(",")
                    .append(useRatioPos(end.y, end2.y))
                    .append(");\r\n");
        } else {
            fillMatrix = matrix;
            fillMatrixEnd = matrixEnd;
            fillData.append("\tvar grd=ctx.createRadialGradient(")
                    .append(useRatioDouble(focalPointRatio * 16384, focalPointRatioEnd * 16384))
                    .append(",0,0,0,0,")
                    .append(16384 + 32768 * repeatCnt)
                    .append(");\r\n");
        }
        ...
        for (int i = 0; i < repeatTotal; i++) {
            ...
            for (int j = 0; j < gradientRecords.length; j++) {
                ...
                fillData.append("\tvar s = ")
                        .append(useRatioDouble(
                                pos + (oneHeight * (revert ? 255 - r.ratio : r.ratio) / 255.0),
                                pos + (oneHeight * (revert ? 255 - r2.ratio : r2.ratio) / 255.0)))
                        .append(";\r\n\tif(s<0) s = 0;\r\n\tif(s>1) s = 1;\r\n");
                fillData.append("\tgrd.addColorStop(s,")
                        .append(useRatioColor(r.color, r2.color))
                        .append(");\r\n");
    ...
    public void beginBitmapFill(
        ...
        if (image != null) {
            ...
            if (img != null) {
                ...
                fillData.append("\tvar fimg = ctrans.applyToImage(imageObj")
                        .append(bitmapId)
                        .append(");\r\n");
    ...
    public void lineStyle(
        ...
        strokeData
                ...
                .append(useRatioDouble(thickness, thicknessEnd))
                .append(";\r\n");
        switch (startCaps) {
    ...
    public void lineGradientStyle(
        ...
        if (type == FILLSTYLE.LINEAR_GRADIENT) {
            ...
            end2.y += deltaY;
            lineFillData
                    .append("\tvar grd=ctx.createLinearGradient(")
                    .append(useRatioPos(start.x, start2.x))
                    .append(",")
                    .append(useRatioPos(start.y, start2.y))
                    .append(",")
            ...
            lineFillData
                    .append("\tvar grd=ctx.createRadialGradient(")
                    .append(useRatioDouble(focalPointRatio * 16384, focalPointRatioEnd * 16384))
                    .append(",0,0,0,0,")
                    .append(16384 + 32768 * repeatCnt)
                    .append(");\r\n");
    ...
    public void moveTo(double x, double y, double x2, double y2) {
        ...
        x2 += deltaX;
        y2 += deltaY;
        pathData.append(Helper.doubleStr(x / unitDivisor))
                .append(" ")
                .append(Helper.doubleStr(x2 / unitDivisor))
                .append(" ")
                .append(Helper.doubleStr(y / unitDivisor))
                .append(" ")
                .append(Helper.doubleStr(y2 / unitDivisor))
                .append(" ");
    }
    ...
    public void curveTo(
        ...
        pathData.append(Helper.doubleStr(controlX / unitDivisor))
                .append(" ")
                .append(Helper.doubleStr(controlX2 / unitDivisor))
                .append(" ")
                .append(Helper.doubleStr(controlY / unitDivisor))
                .append(" ")
                .append(Helper.doubleStr(controlY2 / unitDivisor))
                .append(" ")
                .append(Helper.doubleStr(anchorX / unitDivisor))
                .append(" ")
                .append(Helper.doubleStr(anchorX2 / unitDivisor))
                .append(" ")
                .append(Helper.doubleStr(anchorY / unitDivisor))
                .append(" ")
                .append(Helper.doubleStr(anchorY2 / unitDivisor))
                .append(" ");
    }
        ...
        if (pathData != null && pathData.length() > 0) {
            ...
            if (lineFillData != null) {
                ...
                if (lineLastGradColor != null) {
                    preLineFillData
                            ...
                            .append(lineLastGradColor)
                            .append(";\r\n ctx.fill(\"evenodd\");\r\n");
                }
                preLineFillData
                        .append("\tctx.transform(")
                        .append(useRatioDouble(
                                lineFillMatrix.scaleX / unitDivisor, lineFillMatrixEnd.scaleX / unitDivisor))
                        .append(",")
                        .append(useRatioDouble(
                                lineFillMatrix.rotateSkew0 / unitDivisor, lineFillMatrixEnd.rotateSkew0 / unitDivisor))
                        .append(",")
                        .append(useRatioDouble(
                                lineFillMatrix.rotateSkew1 / unitDivisor, lineFillMatrixEnd.rotateSkew1 / unitDivisor))
                        .append(",")
                        .append(useRatioDouble(
                                lineFillMatrix.scaleY / unitDivisor, lineFillMatrixEnd.scaleY / unitDivisor))
                        .append(",")
                        .append(useRatioDouble(
                                (lineFillMatrix.translateX + deltaX) / unitDivisor,
                                (lineFillMatrixEnd.translateX + deltaX) / unitDivisor))
                        .append(",")
                        .append(useRatioDouble(
                                (lineFillMatrix.translateY + deltaY) / unitDivisor,
                                (lineFillMatrixEnd.translateY + deltaY) / unitDivisor))
                        .append(");\r\n");
                lineFillData.insert(0, preLineFillData);
                lineFillData
                        .append("\tctx.fillRect(")
                        .append(-16384 - 32768 * lineRepeatCnt)
                        .append(",")
                        .append(-16384 - 32768 * lineRepeatCnt)
                        .append(",")
                        .append(2 * 16384 + 32768 * 2 * lineRepeatCnt)
                        .append(",")
                        .append(2 * 16384 + 32768 * 2 * lineRepeatCnt)
                        .append(");\r\n");
            ...
            if (fillMatrix != null) {
                ...
                if (lastGradColor != null) {
                    pathData.append("\tctx.fillStyle=")
                            .append(lastGradColor)
                            .append(";\r\n\tctx.fill(\"evenodd\");\r\n");
                }
                pathData.append("\tctx.save();\r\n");
                pathData.append("\tctx.clip();\r\n");
                pathData.append("\tctx.transform(")
                        .append(useRatioDouble(fillMatrix.scaleX / unitDivisor, fillMatrixEnd.scaleX / unitDivisor))
                        .append(",")
                        .append(useRatioDouble(
                                fillMatrix.rotateSkew0 / unitDivisor, fillMatrixEnd.rotateSkew0 / unitDivisor))
                        .append(",")
                        .append(useRatioDouble(
                                fillMatrix.rotateSkew1 / unitDivisor, fillMatrixEnd.rotateSkew1 / unitDivisor))
                        .append(",")
                        .append(useRatioDouble(fillMatrix.scaleY / unitDivisor, fillMatrixEnd.scaleY / unitDivisor))
                        .append(",")
                        .append(useRatioDouble(
                ...
                pathData.append("\tctx.fillRect(")
                        .append(-16384 - 32768 * repeatCnt)
                        .append(",")
                        .append(-16384 - 32768 * repeatCnt)
                        .append(",")
                        .append(2 * 16384 + 32768 * 2 * repeatCnt)
                        .append(",")
                        .append(2 * 16384 + 32768 * 2 * repeatCnt)
                        .append(");\r\n");
    ...
    private String useRatioPos(double a, double b) {
        return Helper.doubleStr(a / unitDivisor) + "+ratio*(" + Helper.doubleStr((b - a) / unitDivisor) + ")/"
                + DefineMorphShapeTag.MAX_RATIO;
    }
    ...
    private String useRatioColor(RGB color, RGB colorEnd) {
        return "tocolor(ctrans.apply([" + useRatioInt(color.red, colorEnd.red) + ","
                + useRatioInt(color.green, colorEnd.green) + "," + useRatioInt(color.blue, colorEnd.blue) + ",(("
                + useRatioInt(
                        (color instanceof RGBA) ? ((RGBA) color).alpha : 255,
                        (colorEnd instanceof RGBA) ? ((RGBA) colorEnd).alpha : 255)
                + ")/255)]))";
    }

    @Override
    public void lineBitmapStyle(
            int bitmapId,
            Matrix matrix,
            Matrix matrixEnd,
            boolean repeat,
