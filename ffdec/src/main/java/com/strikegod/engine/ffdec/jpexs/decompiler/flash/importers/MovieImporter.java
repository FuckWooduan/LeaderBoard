...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.flv.FLVInputStream;
...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.flv.SCRIPTDATAVARIABLE;
        ...
        for (int characterId : characters.keySet()) {
            ...
            if (tag instanceof DefineVideoStreamTag) {
                ...
                if (existingFilesForMovieTag.size() > 1) {
                    Logger.getLogger(MovieImporter.class.getName())
                            .log(
                                    Level.WARNING,
                                    "Multiple matching files for movie tag {0} exists, {1} selected",
                                    new Object[] {
                                        characterId,
                                        existingFilesForMovieTag.get(0).getName()
                                    });
                }
                ...
                try {
                    ...
                    Logger.getLogger(ShapeImporter.class.getName())
                            .log(
                                    Level.WARNING,
                                    "Cannot import movie " + characterId + " from file " + sourceFile.getName(),
                                    ex);
                }
                    ...
                    switch (movie.codecID) {
                        ...
                        case DefineVideoStreamTag.CODEC_VP6_ALPHA:
                            baos.write(Arrays.copyOfRange(
                                    vdata.videoData, 1 /*strip adjustment*/, vdata.videoData.length));
                            break;
                        default:
