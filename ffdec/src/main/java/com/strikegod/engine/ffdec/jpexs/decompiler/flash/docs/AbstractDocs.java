...
public class AbstractDocs {
    ...
    public static String getStyle() {
        ...
        InputStream is = As3PCodeDocs.class.getResourceAsStream(
                "/com/strikegod/engine/ffdec/jpexs/decompiler/flash/docs/docs.css");
        if (is == null) {
            Logger.getLogger(As3PCodeDocs.class.getName())
                    .log(Level.SEVERE, "docs.css needed for documentation not found");
        } else {
    ...
    protected static String meta(String name, Date content) {
        return "\t\t<meta name=\"" + name + "\" content=\"" + getISO8601StringForDate(content) + "\">"
                + As3PCodeOtherDocs.NEWLINE;
    }
