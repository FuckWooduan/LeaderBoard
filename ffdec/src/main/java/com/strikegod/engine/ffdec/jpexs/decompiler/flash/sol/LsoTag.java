...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.amf.amf0.Amf0InputStream;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.amf.amf0.Amf0OutputStream;
    ...
    public void readData() throws IOException {
        ...
        if (amfVersion == 3) {
            ...
            while (ais.available() > 0) {
                ...
                try {
                    Object varValue =
                            ais.readValue("varValue", new HashMap<>(), objectsTable, traitsTable, stringTable);
                    amfValues.put(varName, varValue);
                } catch (NoSerializerExistsException ex) {
                    throw new IllegalArgumentException("Serializer for class " + ex.getClassName() + " not found");
                }
