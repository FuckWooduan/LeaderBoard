...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.packers.HarmanAirPacker;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.packers.HarmanAirPackerWithKey;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.packers.MochiCryptPacker16Bit;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.packers.MochiCryptPacker32Bit;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.packers.Packer;
...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.base.PackedBinaryData;
...
public class DefineBinaryDataTag extends CharacterTag implements BinaryDataInterface {
    ...
    private static final Packer[] PACKERS = {
        new MochiCryptPacker16Bit(), new MochiCryptPacker32Bit(), new HarmanAirPacker(), new HarmanAirPackerWithKey()
    };
    ...
    public void loadEmbeddedSwf() {
        ...
        String charset = conf == null
                ? "WINDOWS-1252"
                : conf.getCustomData(
                        CustomConfigurationKeys.KEY_CHARSET,
                        Charset.defaultCharset().name());

        try {
            InputStream is =
                    new ByteArrayInputStream(binaryData.getArray(), binaryData.getPos(), binaryData.getLength());
            detectPacker();
            String packerAdd = "";
