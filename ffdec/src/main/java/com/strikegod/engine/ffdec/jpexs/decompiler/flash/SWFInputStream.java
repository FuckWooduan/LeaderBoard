...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.flashlite.ActionFSCommand2;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.flashlite.ActionStrictMode;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.special.ActionEnd;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.special.ActionUnknown;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf1.ActionGetURL;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf1.ActionGotoFrame;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf1.ActionNextFrame;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf1.ActionPlay;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf1.ActionPrevFrame;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf1.ActionStop;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf1.ActionToggleQuality;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf2.ActionStopSounds;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf3.ActionGoToLabel;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf3.ActionSetTarget;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf3.ActionWaitForFrame;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionAdd;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionAnd;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionAsciiToChar;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionCall;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionCharToAscii;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionCloneSprite;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionDivide;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionEndDrag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionEquals;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionGetProperty;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionGetTime;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionGetURL2;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionGetVariable;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionGotoFrame2;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionIf;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionJump;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionLess;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionMBAsciiToChar;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionMBCharToAscii;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionMBStringExtract;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionMBStringLength;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionMultiply;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionNot;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionOr;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionPop;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionPush;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionRandomNumber;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionRemoveSprite;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionSetProperty;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionSetTarget2;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionSetVariable;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionStartDrag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionStringAdd;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionStringEquals;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionStringExtract;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionStringLength;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionStringLess;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionSubtract;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionToInteger;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionTrace;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf4.ActionWaitForFrame2;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionAdd2;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionBitAnd;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionBitLShift;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionBitOr;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionBitRShift;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionBitURShift;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionBitXor;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionCallFunction;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionCallMethod;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionConstantPool;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionDecrement;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionDefineFunction;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionDefineLocal;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionDefineLocal2;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionDelete;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionDelete2;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionEnumerate;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionEquals2;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionGetMember;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionIncrement;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionInitArray;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionInitObject;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionLess2;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionModulo;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionNewMethod;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionNewObject;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionPushDuplicate;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionReturn;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionSetMember;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionStackSwap;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionStoreRegister;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionTargetPath;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionToNumber;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionToString;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionTypeOf;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf5.ActionWith;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf6.ActionEnumerate2;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf6.ActionGreater;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf6.ActionInstanceOf;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf6.ActionStrictEquals;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf6.ActionStringGreater;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf7.ActionCastOp;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf7.ActionDefineFunction2;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf7.ActionExtends;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf7.ActionImplementsOp;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf7.ActionThrow;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.swf7.ActionTry;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.amf.amf3.Amf3InputStream;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.amf.amf3.Amf3Value;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.amf.amf3.NoSerializerExistsException;
...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.dumpview.DumpInfoSpecial;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.dumpview.DumpInfoSpecialType;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.CSMSettingsTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.CharacterSetTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DebugIDTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineBinaryDataTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineBitsJPEG2Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineBitsJPEG3Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineBitsJPEG4Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineBitsLossless2Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineBitsLosslessTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineBitsTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineButton2Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineButtonCxformTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineButtonSoundTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineButtonTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineEditTextTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineFont2Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineFont3Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineFont4Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineFontAlignZonesTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineFontInfo2Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineFontInfoTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineFontNameTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineFontTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineMorphShape2Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineMorphShapeTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineScalingGridTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineSceneAndFrameLabelDataTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineShape2Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineShape3Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineShape4Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineShapeTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineSoundTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineSpriteTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineText2Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineTextFormatTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineTextTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineVideoStreamTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DefineVideoTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DoABC2Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DoABCTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DoActionTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.DoInitActionTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.EnableDebugger2Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.EnableDebuggerTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.EnableTelemetryTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.EndTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.ExportAssetsTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.FileAttributesTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.FontRefTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.FrameLabelTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.FreeAllTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.FreeCharacterTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.GenCommandTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.ImportAssets2Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.ImportAssetsTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.JPEGTablesTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.MetadataTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.NameCharacterTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.PathsArePostScriptTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.PlaceImagePrivateTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.PlaceObject2Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.PlaceObject3Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.PlaceObject4Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.PlaceObjectTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.ProductInfoTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.ProtectTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.RemoveObject2Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.RemoveObjectTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.ScriptLimitsTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.SerialNumberTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.SetBackgroundColorTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.SetTabIndexTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.ShowFrameTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.SoundStreamBlockTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.SoundStreamHead2Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.SoundStreamHeadTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.StartSound2Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.StartSoundTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.SymbolClassTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.SyncFrameTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.Tag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.TagStub;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.UnknownTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.VideoFrameTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.base.ButtonTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.gfx.DefineCompactedFont;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.gfx.DefineExternalGradient;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.gfx.DefineExternalImage;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.gfx.DefineExternalImage2;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.gfx.DefineExternalSound;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.gfx.DefineExternalStreamSound;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.gfx.DefineGradientMap;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.gfx.DefineSubImage;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.gfx.ExporterInfo;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.gfx.FontTextureInfo;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.timeline.Timelined;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.ALPHABITMAPDATA;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.ALPHACOLORMAPDATA;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.ARGB;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.BITMAPDATA;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.BUTTONCONDACTION;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.BUTTONRECORD;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.CLIPACTIONRECORD;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.CLIPACTIONS;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.CLIPEVENTFLAGS;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.COLORMAPDATA;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.CXFORM;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.CXFORMWITHALPHA;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.FILLSTYLE;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.FILLSTYLEARRAY;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.FOCALGRADIENT;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.GLYPHENTRY;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.GRADIENT;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.GRADRECORD;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.KERNINGRECORD;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.LANGCODE;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.LINESTYLE;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.LINESTYLE2;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.LINESTYLEARRAY;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.MATRIX;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.MORPHFILLSTYLE;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.MORPHFILLSTYLEARRAY;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.MORPHFOCALGRADIENT;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.MORPHGRADIENT;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.MORPHGRADRECORD;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.MORPHLINESTYLE;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.MORPHLINESTYLE2;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.MORPHLINESTYLEARRAY;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.PIX15;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.PIX24;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.RECT;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.RGB;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.RGBA;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.SHAPE;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.SHAPEWITHSTYLE;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.SOUNDENVELOPE;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.SOUNDINFO;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.TEXTRECORD;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.ZONEDATA;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.ZONERECORD;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.filters.BEVELFILTER;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.filters.BLURFILTER;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.filters.COLORMATRIXFILTER;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.filters.CONVOLUTIONFILTER;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.filters.DROPSHADOWFILTER;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.filters.FILTER;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.filters.GLOWFILTER;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.filters.GRADIENTBEVELFILTER;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.filters.GRADIENTGLOWFILTER;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.shaperecords.CurvedEdgeRecord;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.shaperecords.EndShapeRecord;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.shaperecords.SHAPERECORD;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.shaperecords.StraightEdgeRecord;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.shaperecords.StyleChangeRecord;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.text.format.ControlTextFormatRecord;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.text.format.EndTextFormatRecord;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.text.format.TextFormatRecord;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.text.format.TextTextFormatRecord;
...
import com.strikegod.engine.ffdec.jpexs.helpers.FakeMemoryInputStream;
import com.strikegod.engine.ffdec.jpexs.helpers.Helper;
import com.strikegod.engine.ffdec.jpexs.helpers.ImmediateFuture;
import com.strikegod.engine.ffdec.jpexs.helpers.MemoryInputStream;
import com.strikegod.engine.ffdec.jpexs.helpers.ProgressListener;
import com.strikegod.engine.ffdec.jpexs.helpers.utf8.Utf8Helper;
import com.strikegod.engine.ffdec.runtime.FfdecExecutors;
...
public class SWFInputStream implements AutoCloseable {
    ...
    private void endDumpLevel(Object value) {
        if (dumpInfo != null) {
            if (dumpInfo.startBit == 0 && bitPos == 0) {
                ...
                dumpInfo.lengthBits = (int)
                        ((is.getPos() - dumpInfo.startByte - 1) * 8 - dumpInfo.startBit + (bitPos == 0 ? 8 : bitPos));
            }
     ...
     * @throws IOException On I/O error
     */
    public ByteArrayRange readByteRangeEx(long count, String name, DumpInfoSpecialType specialType, Object specialValue)
            throws IOException {
        if (count <= 0) {
    ...
    private static void dumpTag(PrintStream out, Tag tag, int index, int level) {
        ...
        // out.println(Utils.formatHex((int)tag.getPos(), 8) + ": " + Utils.indent(level, "") +
        // Utils.format(tag.toString(), 25 - 2*level) + " tagId="+tag.getId()+" len="+tag.getOrigDataLength()+":
        // "+Utils.bytesToHexString(64, tag.getData(version), 0));
    ...
    private class TagResolutionTask implements Callable<Tag> {
         ...
         */
        public TagResolutionTask(
                TagStub tag, DumpInfo dumpInfo, int level, boolean parallel, boolean skipUnusualTags, boolean lazy) {
            this.tag = tag;
    ...
    public List<Tag> readTagList(
            Timelined timelined, int level, boolean parallel, boolean skipUnusualTags, boolean parseTags, boolean lazy)
        ...
        if (parallel1) {
            executor = FfdecExecutors.newBoundedVirtualTaskExecutor("tag-read", Configuration.getParallelThreadCount());
        ...
        while (available() > 0) {
            ...
            if (((parseTags && !parallel1 && doParse) || (tag != null && tag.getId() == ExporterInfo.ID))
                    && (tag instanceof TagStub)) {
            ...
            if (parseTags && doParse && parallel1 && tag instanceof TagStub && executor != null) {
                Future<Tag> future = executor.submit(
                        new TagResolutionTask((TagStub) tag, di, level, parallel1, skipUnusualTags, lazy));
     ...
     * @throws InterruptedException On interrupt
     */
    public static Tag resolveTag(
            TagStub tag, int level, boolean parallel, boolean skipUnusualTags, boolean lazy, boolean logErrors)
        ...
        try {
            ...
            if (logErrors) {
                logger.log(
                        Level.SEVERE,
                        "Error during tag reading. SWF: " + swf.getTitleOrShortFileName() + " ID: " + tag.getId()
                                + " name: " + tag.getName() + " pos: " + data.getPos(),
                        ex);
            }
    ...
    public Tag readTag(
        ...
        DumpInfo di = dumpInfo;
        if (di != null) {
            di.getChildInfos().get(0).previewValue = tagIDTagLength + " (tagID = " + tagID + ", tagLength = "
                    + tagLength + (tagLength == 0x3f ? " => use UI32" : "") + ")";
        }
     ...
     * @throws IOException On I/O error
     */
    public CLIPACTIONRECORD readCLIPACTIONRECORD(SWF swf, Tag tag, String name, CLIPACTIONS parentClipActions)
            throws IOException {
    ...
    public int readRGBAInt(String name) throws IOException {
        newDumpLevel(name, "RGBA");
        int ret = (readUI8("red") << 16) | (readUI8("green") << 8) | readUI8("blue") | (readUI8("alpha") << 24);
        endDumpLevel();
        return ret;
    }
    ...
    public int readARGBInt(String name) throws IOException {
        newDumpLevel(name, "ARGB");
        int ret = (readUI8("alpha") << 24) | (readUI8("red") << 16) | (readUI8("green") << 8) | readUI8("blue");
        endDumpLevel();
        return ret;
    }
    ...
    public int readRGBInt(String name) throws IOException {
        newDumpLevel(name, "RGB");
        int ret = (0xff << 24) | (readUI8("red") << 16) | (readUI8("green") << 8) | readUI8("blue");
        endDumpLevel();
        return ret;
    }
    ...
    public BUTTONRECORD readBUTTONRECORD(SWF swf, ButtonTag tag, String name) throws IOException {
        ...
        if (!ret.buttonHasBlendMode
                && !ret.buttonHasFilterList
                && !ret.buttonStateHitTest
                && !ret.buttonStateDown
                && !ret.buttonStateOver
                && !ret.buttonStateUp
                && ret.reserved == 0) {
    ...
    public FILLSTYLE readFILLSTYLE(int shapeNum, String name) throws IOException {
        ...
        if ((ret.fillStyleType == FILLSTYLE.LINEAR_GRADIENT) || (ret.fillStyleType == FILLSTYLE.RADIAL_GRADIENT)) {
     ...
     * @throws IOException On I/O error
     */
    private SHAPERECORD readSHAPERECORD(int fillBits, int lineBits, int shapeNum, boolean morphShape, String name)
            throws IOException {
        SHAPERECORD ret;
    ...
    private List<SHAPERECORD> readSHAPERECORDS(
            int shapeNum, int fillBits, int lineBits, boolean morphShape, String name) throws IOException {
     ...
     * @throws IOException On I/O error
     */
    public TEXTRECORD readTEXTRECORD(int defineTextNum, int glyphBits, int advanceBits, String name)
            throws IOException {
        ...
        if ((!ret.styleFlagsHasFont)
                && (!ret.styleFlagsHasColor)
                && (!ret.styleFlagsHasYOffset)
                && (!ret.styleFlagsHasXOffset)
                && (first == 0)) { // final text record
            endDumpLevel();
            return null;
        }
        if (ret.styleFlagsHasFont) {
    ...
    public int readPIX24Int(String name) throws IOException {
        newDumpLevel(name, "PIX24");
        int ret = (readUI8("reserved") << 24) | (readUI8("red") << 16) | (readUI8("green") << 8) | readUI8("blue");
        endDumpLevel();
        return ret;
    }
     ...
     * @throws IOException On I/O error
     */
    public COLORMAPDATA readCOLORMAPDATA(int colorTableSize, int bitmapWidth, int bitmapHeight, String name)
            throws IOException {
     ...
     * @throws IOException On I/O error
     */
    public BITMAPDATA readBITMAPDATA(int bitmapFormat, int bitmapWidth, int bitmapHeight, String name)
            throws IOException {
     ...
     * @throws IOException On I/O error
     */
    public ALPHABITMAPDATA readALPHABITMAPDATA(int bitmapFormat, int bitmapWidth, int bitmapHeight, String name)
            throws IOException {
     ...
     * @throws IOException On I/O error
     */
    public ALPHACOLORMAPDATA readALPHACOLORMAPDATA(int colorTableSize, int bitmapWidth, int bitmapHeight, String name)
            throws IOException {
