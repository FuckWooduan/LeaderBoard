...
public class GetLexAVM2Item extends AVM2Item {
    ...
    public GraphTextWriter appendTo(GraphTextWriter writer, LocalData localData) {
        ...
        String localName = propertyName.getNameAndCustomNamespace(
                localData.usedDeobfuscations, localData.abc, localData.fullyQualifiedNames, false, true, customNsRef);
        ...
        if (customNs != null) {
            ...
            if (localData.classIndex > -1) {
                DottedChain fullClassName = localData
                        .abc
                        .instance_info
                        .get(localData.classIndex)
                        .getName(localData.abc.constants)
                        .getNameWithNamespace(new HashSet<>(), localData.abc, localData.abc.constants, false);
                ambiguous = localData.abcIndex.isPropertyAmbiguous(
                        localData.abc, localName, new TypeItem(fullClassName), true, true);
            }
