...
public class FindPropertyAVM2Item extends AVM2Item {
     ...
     */
    public FindPropertyAVM2Item(
            GraphSourceItem instruction, GraphSourceItem lineStartIns, GraphTargetItem propertyName) {
    ...
    public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData, SourceGenerator generator)
        ...
        return toSourceMerge(
                ...
                generator,
                ins(
                        AVM2Instructions.FindProperty,
                        ((AVM2SourceGenerator) generator).typeName(localData, propertyName)));
    }
