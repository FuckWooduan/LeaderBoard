...
public class MethodNameMultinameUsage extends MethodMultinameUsage implements DefinitionUsage {
     ...
     */
    public MethodNameMultinameUsage(
            ABC abc,
            int multinameIndex,
            int scriptIndex,
            int classIndex,
    ...
    public boolean collides(MultinameUsage other) {
        if ((other instanceof MethodNameMultinameUsage) || (other instanceof ConstVarNameMultinameUsage)) {
            ...
            if (otherTrait.classIndex == classIndex
                    && otherTrait.traitsType == traitsType
                    && otherTrait.parentTraitIndex == parentTraitIndex) {
                if (other.sameMultinameName(this, false)) {
                    ...
                    if (other instanceof MethodNameMultinameUsage) {
                        ...
                        if (otherM.traits.traits.get(otherM.traitIndex).kindType
                                != traits.traits.get(traitIndex).kindType) {
                            return false;
                        }
                    }
                    return true;
