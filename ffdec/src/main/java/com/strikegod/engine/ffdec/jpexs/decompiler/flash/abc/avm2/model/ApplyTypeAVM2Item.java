...
public class ApplyTypeAVM2Item extends AVM2Item {
    ...
    public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData, SourceGenerator generator)
        ...
        // int qname = AVM2SourceGenerator.resolveType(localData, object, ((AVM2SourceGenerator)generator).abc,
        ...
        return toSourceMerge(localData, generator, object, nparams, ins(AVM2Instructions.ApplyType, params.size()));
    }
