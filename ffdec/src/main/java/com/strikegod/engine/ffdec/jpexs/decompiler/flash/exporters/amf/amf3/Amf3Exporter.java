...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.amf.amf3.WithSubValues;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.amf.amf3.types.AbstractVectorType;
...
public class Amf3Exporter {
    ...
    public static void populateObjects(
        ...
        if (((List<? extends Class>)
                        Arrays.asList(String.class, Long.class, Double.class, BasicType.class, Boolean.class))
     ...
     */
    private static String amfToString(
            String indentStr,
            String newLine,
        ...
        if (((List<? extends Class>) Arrays.asList(Long.class, Double.class, Boolean.class))
                .contains(object.getClass())) {
        ...
        if (object instanceof AbstractVectorType) {
            ...
            if (ot.isSerialized()) {
                ...
                if (serData == null) {
                    ret.append(indent(level + 1))
                            .append("\"serialized\": unknown")
                            .append(newLine);
                } else {
                    ret.append(indent(level + 1))
                            .append("\"serialized\": \"")
                            .append(Helper.byteArrayToHex(serData))
                            .append("\",")
                            .append(newLine);
                    if (!ot.getSerializedMembers().isEmpty()) {
                        ret.append(indent(level + 1))
                                .append("\"unserializedMembers\": {")
                                .append(newLine);
                        if (true) {
                            int i = 0;
                ...
                if (true) {
                    ...
                    for (String key : ot.dynamicMembersKeySet()) {
                        ...
                        ret.append(": ");
                        ret.append(amfToString(
                                indentStr, newLine, processedObjects, level + 2, val, referenceCount, objectAlias));
            ...
            for (String key : at.associativeKeySet()) {
                ...
                ret.append(indent(level + 2))
                        .append(amfToString(
                                indentStr, newLine, processedObjects, level + 1, key, referenceCount, objectAlias))
                        .append(" : ")
                        .append(amfToString(
                                indentStr, newLine, processedObjects, level + 1, val, referenceCount, objectAlias));
            ...
            for (Object key : dt.keySet()) {
                ...
                ret.append(indent(level + 3))
                        .append("\"key\": ")
                        .append(amfToString(
                                indentStr, newLine, processedObjects, level + 3, key, referenceCount, objectAlias))
                        .append(",")
                        .append(newLine);
                ret.append(indent(level + 3))
                        .append("\"value\": ")
                        .append(amfToString(
                                indentStr, newLine, processedObjects, level + 3, val, referenceCount, objectAlias))
                        .append(newLine);
            ...
            return "{" + newLine
                    ...
                    + amfToString(
                            ...
                            processedObjects,
                            level,
                            sdf.format(new Date((long) dt.getVal())),
                            referenceCount,
                            objectAlias)
                    + newLine
                    + indent(level) + "}";
    ...
    public static String amfMapToString(Map<String, Object> map, String indentStr, String newLine, int level) {
        ...
        for (String key : map.keySet()) {
            ...
            sb.append(indent(level + 1))
                    .append("\"")
                    .append(Helper.escapeActionScriptString(key))
                    .append("\": ");
            sb.append(
                    amfToString(indentStr, newLine, processedObjects, level + 1, map.get(key), refCount, objectAlias));
        }
        sb.append(newLine);
