...
import com.strikegod.engine.ffdec.jpexs.decompiler.graph.EqualsTypeItem;
...
public class StrictEqAVM2Item extends BinaryOpItem implements LogicalOpItem, IfCondition, EqualsTypeItem {
    ...
    public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData, SourceGenerator generator)
        ...
        return toSourceMerge(
                localData, generator, leftSide, rightSide, new AVM2Instruction(0, AVM2Instructions.StrictEquals, null));
    }
