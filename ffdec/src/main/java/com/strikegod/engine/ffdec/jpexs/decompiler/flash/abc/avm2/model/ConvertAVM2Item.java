        ...
        switch (type.toString()) {
            ...
            case "uint":
                if (valueReturnType.equals(TypeItem.INT) && (value instanceof IntegerValueAVM2Item)) {
                    ...
                    displayConvert = !valueReturnType.equals(
                            TypeItem.UINT); //    && !valueReturnType.equals(TypeItem.UNBOUNDED);
                }
                break;
            case "String":
                displayConvert = !valueReturnType.equals(TypeItem.STRING)
                        ...
                        && !valueReturnType.equals(
                                new TypeItem("null")); // && !valueReturnType.equals(TypeItem.UNBOUNDED);
                break;
        }
        if (displayConvert) {
