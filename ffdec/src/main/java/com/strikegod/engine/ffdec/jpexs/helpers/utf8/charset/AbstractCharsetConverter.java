...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.parser.script.ActionScriptLexer;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.parser.script.ParsedSymbol;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.parser.script.SymbolType;
...
public abstract class AbstractCharsetConverter {
     ...
     */
    protected static void readMap(Map<Integer, Integer> data, ActionScriptLexer lexer)
     ...
     * @throws ActionParseException On action parse error
     */
    protected static void readOneDimensionalInt(int[] data, ActionScriptLexer lexer)
            throws IOException, ActionParseException {
        ParsedSymbol s;
        lexer.lex(); // identifier
        lexer.lex(); // =
     ...
     * @throws ActionParseException On action parse error
     */
    protected static void readTwoDimensionalInt(int[][] data, ActionScriptLexer lexer)
            throws IOException, ActionParseException {
        ParsedSymbol s;
        lexer.lex(); // identifier;
        lexer.lex(); // =
