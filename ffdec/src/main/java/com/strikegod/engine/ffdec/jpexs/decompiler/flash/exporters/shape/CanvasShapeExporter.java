 ...
 */
package com.strikegod.engine.ffdec.jpexs.decompiler.flash.exporters.shape;
...
public class CanvasShapeExporter extends ShapeExporterBase {
    ...
    public static String getHtmlPrefix(int width, int height) {
        return "<!DOCTYPE html>\r\n"
                ...
                + "<body>\r\n"
                + "\r\n"
                + "<div id=\"resizable\"><canvas id=\"myCanvas\" width=\"" + width + "\" height=\"" + height
    ...
    public String getHtml(String needed, String id, RECT rect) {
        ...
        return getHtmlPrefix(width, height)
                + getJsPrefix()
                + needed
    ...
    public void beginGradientFill(
        ...
        if (type == FILLSTYLE.LINEAR_GRADIENT) {
            ...
            fillData.append("\tvar grd=ctx.createLinearGradient(")
                    .append(start.x / unitDivisor)
                    .append(",")
                    .append(start.y / unitDivisor)
                    .append(",")
                    .append(end.x / unitDivisor)
                    .append(",")
                    .append(end.y / unitDivisor)
                    .append(");\r\n");
        } else {
            fillMatrix = matrix;
            fillData.append("\tvar grd=ctx.createRadialGradient(")
                    .append(focalPointRatio * 16384)
                    .append(",0,0,0,0,")
        ...
        for (int i = 0; i < repeatTotal; i++) {
            ...
            for (GRADRECORD r : gradientRecords) {
                fillData.append("\tgrd.addColorStop(")
                        .append(pos + (oneHeight * (revert ? 255 - r.ratio : r.ratio) / 255.0))
                        .append(",")
                        .append(color(r.color))
                        .append(");\r\n");
    ...
    public void beginBitmapFill(
            int bitmapId, Matrix matrix, boolean repeat, boolean smooth, ColorTransform colorTransform) {
        finalizePath();
        ...
        fillData.append("\tctx.fillStyle=")
                .append(color(SWF.ERROR_COLOR.getRGB()))
                .append(";\r\n");
    }
    ...
    public void lineStyle(
        ...
        strokeData
                ...
                .append(thickness == 0 ? 1 : thickness)
                .append(";\r\n");
        switch (startCaps) {
    ...
    public void lineGradientStyle(
        ...
        if (type == FILLSTYLE.LINEAR_GRADIENT) {
            ...
            lineFillData
                    ...
                    .append(Double.toString(start.x / unitDivisor))
                    .append(",")
                    .append(Double.toString(start.y / unitDivisor))
                    .append(",")
                    .append(Double.toString(end.x / unitDivisor))
                    .append(",")
                    .append(Double.toString(end.y / unitDivisor))
                    .append(");\r\n");
        } else {
        ...
        for (int i = 0; i < repeatTotal; i++) {
            ...
            for (GRADRECORD r : gradientRecords) {
                lineFillData
                        .append("\tgrd.addColorStop(")
                        .append(Double.toString(pos + (oneHeight * (revert ? 255 - r.ratio : r.ratio) / 255.0)))
                        .append(",")
                        .append(color(r.color))
                        .append(");\r\n");
        ...
        if (pathData != null && pathData.length() > 0) {
            ...
            if (lineFillData != null) {
                ...
                if (lineLastGradColor != null) {
                    preLineFillData
                            ...
                            .append(";\r\n\tctx.fill(\"")
                            .append(windingRule == ShapeTag.WIND_NONZERO ? "nonzero" : "evenodd")
                            .append("\");\r\n");
                }
                ...
                if (lineFillMatrix != null) {
                    preLineFillData
                            ...
                            .append(Helper.doubleStr(lineFillMatrix.scaleX / unitDivisor))
                            .append(",")
                            .append(Helper.doubleStr(lineFillMatrix.rotateSkew0 / unitDivisor))
                            .append(",")
                            .append(Helper.doubleStr(lineFillMatrix.rotateSkew1 / unitDivisor))
                            .append(",")
                            .append(Helper.doubleStr(lineFillMatrix.scaleY / unitDivisor))
                            .append(",")
                            .append(Helper.doubleStr((lineFillMatrix.translateX + deltaX) / unitDivisor))
                            .append(",")
                            .append(Helper.doubleStr((lineFillMatrix.translateY + deltaY) / unitDivisor))
                            .append(");\r\n");
                }
            ...
            if (fillMatrix != null) {
                ...
                pathData.append("\tctx.transform(")
                        .append(Helper.doubleStr(fillMatrix.scaleX / unitDivisor))
                        .append(",")
                        .append(Helper.doubleStr(fillMatrix.rotateSkew0 / unitDivisor))
                        .append(",")
                        .append(Helper.doubleStr(fillMatrix.rotateSkew1 / unitDivisor))
                        .append(",")
                        .append(Helper.doubleStr(fillMatrix.scaleY / unitDivisor))
                        .append(",")
                        .append(Helper.doubleStr((fillMatrix.translateX + deltaX) / unitDivisor))
                        .append(",")
                        .append(Helper.doubleStr((fillMatrix.translateY + deltaY) / unitDivisor))
                        .append(");\r\n");
