 ...
 */
package com.strikegod.engine.ffdec.jpexs.decompiler.flash.abc.avm2.model.operations;
...
public class LtAVM2Item extends BinaryOpItem implements LogicalOpItem, IfCondition {
    ...
    public int getIfDefinition() {
        return AVM2Instructions.IfLt;
    }

    @Override
    public int getIfNotDefinition() {
        return AVM2Instructions.IfNLt;
    }

    @Override
    public GraphTargetItem invert(GraphSourceItem neqSrc) {
        return new GeAVM2Item(getSrc(), getLineStartItem(), leftSide, rightSide);
    }
    ...
    public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData, SourceGenerator generator)
        ...
        return toSourceMerge(
                localData, generator, leftSide, rightSide, new AVM2Instruction(0, AVM2Instructions.LessThan, null));
    }
