...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.helpers.CodeFormatting;
...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.helpers.LazyObject;
...
public class SwfJavaExporter {
    ...
    private static final String[] allowedSubTypes = new String[] {
        "List",
        "String",
        "ByteArrayRange",
        "RECT",
    ...
    public void exportJavaCode(SWF swf, GraphTextWriter writer) throws IOException {
        ...
        writer.append("package com.strikegod.engine.ffdec.jpexs.decompiler.flash.exporters.swf;")
                .newLine();
        writer.newLine();
        writer.append("import com.strikegod.engine.ffdec.jpexs.decompiler.flash.SWF;")
                .newLine();
        writer.append("import com.strikegod.engine.ffdec.jpexs.decompiler.flash.SWFCompression;")
                .newLine();
        writer.append("import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.*;")
                .newLine();
        if (swf.gfx) {
            writer.append("import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.gfx.*;")
                    .newLine();
        }
        writer.append("import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.*;")
                .newLine();
        if (swf.gfx) {
            writer.append("import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.gfx.*;")
                    .newLine();
        }
        writer.append("import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.filters.*;")
                .newLine();
        writer.append("import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.shaperecords.*;")
                .newLine();
        writer.append("import com.strikegod.engine.ffdec.jpexs.helpers.ByteArrayRange;")
                .newLine();
        ...
        writer.newLine();
        writer.append("    public void saveTo(String fileName) throws IOException {")
                .newLine();
        writer.append("        SWF swf = getSwf();").newLine();
        writer.append("        swf.clearModified();").newLine();
        writer.append("        try (FileOutputStream fos = new FileOutputStream(fileName)) {")
                .newLine();
    ...
    private static Object generateJavaCode(
            GraphTextWriter writer, IndentedStringBuilder sb, Map<String, Integer> objectNames, Object obj, int level) {
        if (obj == null) {
            return null;
        }
