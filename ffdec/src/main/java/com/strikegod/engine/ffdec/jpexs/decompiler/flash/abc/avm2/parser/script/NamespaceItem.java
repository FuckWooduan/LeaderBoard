...
public class NamespaceItem {
    ...
    public void resolveCustomNs(
        ...
        if (kind == KIND_NAMESPACE_CUSTOM) {
            ...
            PropertyAVM2Item prop = new PropertyAVM2Item(
                    null,
                    false,
                    custom,
                    "",
                ...
                if (ti != null) {
                    if (ti.trait instanceof TraitSlotConst) {
                        if (((TraitSlotConst) ti.trait).isNamespace()) {
                            ...
                            nsIndex = abcIndex.getSelectedAbc()
                                    .constants
                                    .getNamespaceId(ns.kind, ns.getName(ti.abc.constants), 0, true);
                            kind = ns.kind;
                            return;
                        }
                    }
            ...
            nsIndex = abcIndex.getSelectedAbc()
                    .constants
                    .getNamespaceId(ns.kind, ns.getName(outAbc.getVal().constants), 0, true);
     ...
     * @throws CompilationException On compilation error
     */
    public static int getCpoolSetIndex(AbcIndexing abcIndex, List<NamespaceItem> namespaces)
            throws CompilationException {
