...
public abstract class AssignableAVM2Item extends AVM2Item {
    ...
    protected GraphTargetItem makeCoerced(GraphTargetItem assignedValue, GraphTargetItem targetType) {
        if (assignedValue instanceof OrItem) {
            ...
            return new OrItem(
                    dialect,
                    assignedValue.getSrc(),
                    assignedValue.getLineStartItem(),
                    makeCoerced(oi.leftSide, targetType),
                    makeCoerced(oi.rightSide, targetType));
        }
     ...
     */
    public abstract List<GraphSourceItem> toSourceChange(
     ...
     * @return Source
     */
    public static List<GraphSourceItem> dupSetTemp(
            SourceGeneratorLocalData localData, SourceGenerator generator, Reference<Integer> register) {
     ...
     * @return Source
     */
    public static List<GraphSourceItem> setTemp(
            SourceGeneratorLocalData localData, SourceGenerator generator, Reference<Integer> register) {
        register.setVal(getFreeRegister(localData, generator));
        List<GraphSourceItem> ret = new ArrayList<>();
        ret.add(generateSetLoc(register.getVal()));
     ...
     * @return Source
     */
    public static List<GraphSourceItem> getTemp(
            SourceGeneratorLocalData localData, SourceGenerator generator, Reference<Integer> register) {
     ...
     * @return Source
     */
    public static List<GraphSourceItem> killTemp(
            SourceGeneratorLocalData localData, SourceGenerator generator, List<Reference<Integer>> registers) {
        List<GraphSourceItem> ret = new ArrayList<>();
     ...
     * @throws CompilationException On compilation error
     */
    public static List<GraphSourceItem> generateSetSlot(
            SourceGeneratorLocalData localData,
            SourceGenerator generator,
            GraphTargetItem val,
            int slotScope,
