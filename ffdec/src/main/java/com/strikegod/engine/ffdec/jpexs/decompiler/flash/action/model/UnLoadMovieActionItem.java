...
public class UnLoadMovieActionItem extends ActionItem {
     ...
     */
    public UnLoadMovieActionItem(
            GraphSourceItem instruction, GraphSourceItem lineStartIns, GraphTargetItem targetString) {
    ...
    private List<GraphSourceItem> toSource(
        ...
        return toSourceMerge(
                ...
                targetString,
                new ActionGetURL2(0, false, true, charset),
