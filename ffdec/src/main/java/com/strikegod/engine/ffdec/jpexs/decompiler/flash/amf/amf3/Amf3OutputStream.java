...
public class Amf3OutputStream extends OutputStream {
        ...
        if (objectIndex == -1) {
            ...
            if (traitsIndex == -1) {
                if (val.isSerialized()) {
                    ...
                    writeU29((val.sealedMembersSize() << 4)
                            | NO_REFERENCE_FLAG
                            | NO_TRAIT_REFERENCE_FLAG
                            | (traits.isDynamic() ? DYNAMIC_FLAG : 0));
                    writeUtf8Vr(val.getClassName(), stringTable);
     ...
     * @throws NoSerializerExistsException If no serializer exists
     */
    public void writeValue(Object object, Map<String, ObjectTypeSerializeHandler> serializers)
            throws IOException, NoSerializerExistsException {
