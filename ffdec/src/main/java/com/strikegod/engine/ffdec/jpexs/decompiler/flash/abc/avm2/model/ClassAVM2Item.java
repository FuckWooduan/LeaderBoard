        ...
        if (classNameAsStr != null) {
            if (localData.fullyQualifiedNames != null && localData.fullyQualifiedNames.contains(classNameAsStr)) {
                return writer.append(
                        classNameAsStr.toPrintableString(localData.usedDeobfuscations, localData.swf, true));
            }
            return writer.append(IdentifiersDeobfuscation.printIdentifier(
                    localData.abc.getSwf(), localData.usedDeobfuscations, true, classNameAsStr.getLast()));
        }
        return writer.append(className.getName(
