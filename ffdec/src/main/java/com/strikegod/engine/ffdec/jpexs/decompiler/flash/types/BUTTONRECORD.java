...
public class BUTTONRECORD implements Serializable, TreeItem, HasSwfAndTag, HasCharacterId {
    ...
    @SWFArray("filter")
    @Conditional(
            value = "buttonHasFilterList",
            tags = {DefineButton2Tag.ID})
    ...
    public String toString() {
        return "BUTTONRECORD (chid: " + characterId + ", dpt: " + placeDepth + ", state: "
                + ((buttonStateDown ? "down " : "")
                                + (buttonStateHitTest ? "hit " : "")
    ...
    public void fromPlaceObject(PlaceObjectTypeTag placeObject) {
        ...
        colorTransform = importedColorTrans == null
                ? new CXFORMWITHALPHA()
                : new CXFORMWITHALPHA(placeObject.getColorTransform());
    ...
    public PlaceObject3Tag toPlaceObject() {
        ...
        if (buttonTag instanceof DefineButtonTag) {
            ...
            DefineButtonCxformTag cxformTag = (DefineButtonCxformTag)
                    button1Tag.getSwf().getCharacterIdTag(button1Tag.getCharacterId(), DefineButtonCxformTag.ID);
            if (cxformTag != null) {
