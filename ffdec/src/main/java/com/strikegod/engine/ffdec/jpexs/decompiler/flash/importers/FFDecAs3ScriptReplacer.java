...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.abc.avm2.parser.script.ActionScript3Parser;
...
public class FFDecAs3ScriptReplacer implements As3ScriptReplacerInterface {
    ...
    @Override
    public void replaceScript(ScriptPack pack, String text, List<SWF> dependencies)
        ...
        try {
            ...
            ActionScript3Parser.compile(
                    text, abc, abcIndex, scriptName, newClassIndex, oldIndex, air, swf.getDocumentClass());
            if (pack.isSimple) {
