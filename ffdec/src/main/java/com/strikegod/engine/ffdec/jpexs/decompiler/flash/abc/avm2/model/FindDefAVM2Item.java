...
public class FindDefAVM2Item extends AVM2Item {
    ...
    public GraphTextWriter appendTo(GraphTextWriter writer, LocalData localData) {
        return writer.append(propertyName
                .getNamespace(localData.constantsAvm2)
                .getName(localData.constantsAvm2)
                .toPrintableString(localData.usedDeobfuscations, localData.swf, true)); // assume not null name
    }
