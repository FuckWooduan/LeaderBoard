...
public class NamespacedAVM2Item extends AssignableAVM2Item {
     ...
     */
    public NamespacedAVM2Item(
            GraphTargetItem ns,
            String name,
            GraphTargetItem nameItem,
            GraphTargetItem obj,
            boolean attr,
        ...
        */
        ...
        if (name != null) {
            return toSourceMerge(
                    ...
                    generator,
                    ns,
                    NameAVM2Item.generateCoerce(localData, generator, new TypeItem(DottedChain.NAMESPACE)),
                    ins(
                            AVM2Instructions.FindPropertyStrict,
                            constants.getMultinameId(
                                    Multiname.createRTQName(false, constants.getStringId(name, true)), true)),
                    dupSetTemp(localData, generator, name_temp),
                    ns,
                    NameAVM2Item.generateCoerce(localData, generator, new TypeItem(DottedChain.NAMESPACE)),
                    dupSetTemp(localData, generator, ns_temp),
                    ...
                    // ins(AVM2Instructions.FindPropertyStrict, g.abc.getLastAbc().constants.getMultinameId(new
                    // Multiname(Multiname.RTQNAME, g.abc.getLastAbc().constants.getStringId(variableName, true), 0, 0,
                    // 0, new ArrayList<Integer>()), true)),
                    // getTemp(localData, generator, ns_temp), generateCoerce(generator, "Namespace"),
                    ins(
                            AVM2Instructions.GetProperty,
                            constants.getMultinameId(Multiname.createMultinameL(false, allNsSet(g.abcIndex)), true)),
                    !isInteger ? ins(AVM2Instructions.ConvertD) : null,
                    // End get original
                    (!post) ? changeIns : null,
                    needsReturn ? ins(AVM2Instructions.Dup) : null,
            ...
            if (assignedValue != null) {
                return toSourceMerge(
                        ...
                        obj == null
                                ...
                                : null,
                        nameItem,
                        ins(AVM2Instructions.ConvertS),
                        obj != null
                                ? obj
                                : ins(
                                        AVM2Instructions.FindPropertyStrict,
                                        constants.getMultinameId(Multiname.createRTQNameL(false), true)),
                        ns,
                        NameAVM2Item.generateCoerce(localData, generator, new TypeItem(DottedChain.NAMESPACE)),
                        nameItem,
                        ins(AVM2Instructions.ConvertS),
                ...
                return toSourceMerge(
                        ...
                        ins(
                                construct
                                        ? AVM2Instructions.ConstructProp
                                        : delete ? AVM2Instructions.DeleteProperty : AVM2Instructions.GetProperty,
                                constants.getMultinameId(Multiname.createRTQNameL(false), true),
                                construct ? callargs.size() : null),
            ...
            return toSourceMerge(
                    ...
                    obj != null
                            ...
                            : ins(
                                    AVM2Instructions.FindPropertyStrict,
                                    constants.getMultinameId(
                                            Multiname.createRTQName(attr, constants.getStringId(name, true)), true)),
                    ns,
                    NameAVM2Item.generateCoerce(localData, generator, new TypeItem(DottedChain.NAMESPACE)),
                    assignedValue,
                    needsReturn ? dupSetTemp(localData, generator, ret_temp) : null,
