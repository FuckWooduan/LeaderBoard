...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.DisplayObject;
...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.model.GotoFrameActionItem;
...
public class ActionPlay extends Action {
    ...
    public void translate(
        ...
        if (!output.isEmpty() && (output.get(output.size() - 1) instanceof GotoFrameActionItem)) {
            ...
            stack.addToOutput(new GotoFrame2ActionItem(
                    this, lineStartAction, new DirectValueActionItem(gta.frame + 1), false, true, 0));
        } else {
            stack.moveToStack(output);
