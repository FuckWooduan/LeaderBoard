...
public class SwfIntelliJIdeaExporter {
     ...
     * @throws IOException On I/O error
     */
    public void exportIntelliJIdeaProject(
            SWF swf, File outDir, AbortRetryIgnoreHandler handler, EventListener eventListener) throws IOException {
        if (!swf.isAS3()) {
        ...
        additionalOptions.add("-default-size " + Math.round(swf.displayRect.getWidth() / SWF.unitDivisor) + " "
        ...
        if (swf.getBackgroundColor() != null) {
            additionalOptions.add("-default-background-color "
                    + swf.getBackgroundColor().backgroundColor.toHexRGB());
        }
        ...
        String imlData = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
                ...
                + "    <configurations>\n"
                + "      <configuration name=\"" + simpleName + "\" pure-as=\"true\" main-class=\"" + documentClass
                + "\" output-file=\"" + simpleName + ".swf\" output-folder=\"$MODULE_DIR$/out/production/" + simpleName
                + "\">\n"
        ...
        String modulesXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
                ...
                + "    <modules>\n"
                + "      <module fileurl=\"file://$PROJECT_DIR$/" + simpleName + ".iml" + "\" filepath=\"$PROJECT_DIR$/"
                + simpleName + ".iml" + "\" />\n"
                + "    </modules>\n"
                + "  </component>\n"
                + "</project>";
        ...
        swf.exportActionScript(
                handler, new File(outDir, "src").getAbsolutePath(), scriptExportSettings, parallel, eventListener);
    }
}
