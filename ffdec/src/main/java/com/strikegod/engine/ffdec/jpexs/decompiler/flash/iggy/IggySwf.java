...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.iggy.annotations.IggyFieldType;
...
public class IggySwf implements StructureInterface {
    ...
    public void readFromDataStream(ReadDataStreamInterface s) throws IOException {
        ...
        long[] seq_addresses = new long[] {
            hdr.getSequenceStartAddress1(), hdr.getSequenceStartAddress2(), hdr.getSequenceStartAddress3()
        };
    ...
    public void writeToDataStream(WriteDataStreamInterface s) throws IOException {
        ...
        long[] seq_ofs_pos = new long[] {
            hdr.getSequence_start1_ofs_pos(), hdr.getSequence_start2_ofs_pos(), hdr.getSequence_start3_ofs_pos()
        };
        long[] off_seq_expected =
                new long[] {hdr.off_sequence_start1, hdr.off_sequence_start2, hdr.off_sequence_start3};
