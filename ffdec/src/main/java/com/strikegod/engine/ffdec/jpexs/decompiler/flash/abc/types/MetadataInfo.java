...
public class MetadataInfo {
    ...
    public String toString() {
        return "name_index=" + name_index + " keys=" + Helper.intArrToString(keys) + " values="
                + Helper.intArrToString(values);
    }
    ...
    public String toString(AVM2ConstantPool constants) {
        ...
        for (int i = 0; i < keys.length; i++) {
            if (keys[i] == 0) {
                ...
                sb.append("\"")
                        .append(constants.getString(keys[i]))
                        .append("\"=\"")
                        .append(constants.getString(values[i]))
                        .append("\"\r\n");
            }
        }
        return sb.toString();
