...
public class ActionStackSwap extends Action {
    ...
    public void translate(
        ...
        stack.addToOutput(new SetTemporaryItem(
                ActionGraphTargetDialect.INSTANCE, this, localData.lineStartInstruction, o2, temp, "swap", 1));
        stack.push(o1);
        stack.push(
                new TemporaryItem(ActionGraphTargetDialect.INSTANCE, this, localData.lineStartInstruction, o2, temp));
        stack.finishBlock(output);
    }
