...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.importers.SwfXmlImporter;
...
public class SwfToSwcExporter {
    ...
    private String generateCatalog(SWF swf, byte[] swfBytes, boolean skipDependencies) throws InterruptedException {
        ...
        sb.append("<?xml version=\"1.0\" encoding =\"utf-8\"?>\n")
                ...
                .append("\" build=\"")
                .append(FLEX_BUILD)
                .append("\" minimumSupportedVersion=\"")
                .append(MINIMUM_SUPPORTED_VERSION)
                .append("\" />\n")
                .append("  </versions>\n")
                .append("  <features>\n")
        ...
        for (ABCContainerTag abcContainer : abcTagList) {
            ...
            for (ScriptPack pack : tagPacks) {
                ...
                sb.append("        <dep id=\"AS3\" type=\"")
                        .append(DEPENDENCY_NAMESPACE)
                        .append("\" />\n");
                if (!skipDependencies) {
                    List<Dependency> dependencies = new ArrayList<>();
                    pack.abc
                            .script_info
                            .get(pack.scriptIndex)
                            .traits
                            .getDependencies(
                                    new LinkedHashSet<>(),
                                    swf.getAbcIndex(),
                                    ...
                                    pack.abc,
                                    dependencies,
                                    new DottedChain(new String[] {"NO:PACKAGE"}),
                                    new ArrayList<>(),
                                    new ArrayList<>(),
                                    new Reference<>(null));
                    ...
                    for (Dependency d : dependencies) {
                        ...
                        sb.append("        <dep id=\"")
                                .append(dottedChainToId(d.getId()))
                                .append("\" type=\"")
                                .append(getDependencyStr(d.getType()))
                                .append("\" />\n");
        ...
        sb.append("      <digests>\n")
                .append("        <digest type=\"SHA-256\" signed=\"false\" value=\"")
                .append(sha256Hash)
                .append("\" />\n")
                .append("      </digests>\n")
                .append("    </library>\n")
    ...
    public void exportSwf(SWF swf, File outSwcFile, boolean skipDependencies) throws IOException, InterruptedException {
        ...
        try {
            ...
            String abcTagXml = new String(
                    Helper.readStream(SwfToSwcExporter.class.getResourceAsStream(
                            "/com/strikegod/engine/ffdec/jpexs/decompiler/flash/exporters/swf/swc_main_abctag.xml")),
                    "UTF-8");
