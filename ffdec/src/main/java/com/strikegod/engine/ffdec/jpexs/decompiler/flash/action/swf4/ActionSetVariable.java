    ...
    public void translate(
        ...
        if (value instanceof IncrementActionItem) {
            if (((IncrementActionItem) value).object instanceof GetVariableActionItem) {
                if (((GetVariableActionItem) ((IncrementActionItem) value).object).name.valueEquals(name)) {
                    ...
                    stack.addToOutput(
                            new PostIncrementActionItem(this, lineStartAction, ((IncrementActionItem) value).object));
                    return;
                }
            }
                ...
                if (((IncrementActionItem) value).object.value instanceof DuplicateItem) {
                    if (((IncrementActionItem) value).object.value.value == name) {
                        stack.addToOutput(new PostIncrementActionItem(
                                this, lineStartAction, new GetVariableActionItem(null, null, name)));
                        return;
                    }
                }
            }
        ...
        if (value instanceof DecrementActionItem) {
            if (((DecrementActionItem) value).object instanceof GetVariableActionItem) {
                if (((GetVariableActionItem) ((DecrementActionItem) value).object).name.valueEquals(name)) {
                    ...
                    stack.addToOutput(
                            new PostDecrementActionItem(this, lineStartAction, ((DecrementActionItem) value).object));
                    return;
                }
            }
        ...
        if (inside instanceof CompoundableBinaryOpAs12) {
            if (!name.hasSideEffect()) {
                ...
                } else if (binaryOp.getLeftSide() instanceof EvalActionItem
                    ...
                    if (((IncrementActionItem) value).object instanceof GetVariableActionItem) {
                        if (((GetVariableActionItem) ((IncrementActionItem) value).object).name.valueEquals(name)) {
                            ...
                            ret = new PreIncrementActionItem(
                                    this, lineStartAction, ((IncrementActionItem) value).object);
                        }
                    }
                    ...
                    if (((DecrementActionItem) value).object instanceof GetVariableActionItem) {
                        if (((GetVariableActionItem) ((DecrementActionItem) value).object).name.valueEquals(name)) {
                            ...
                            ret = new PreDecrementActionItem(
                                    this, lineStartAction, ((DecrementActionItem) value).object);
                        }
                    }
                } else {
                    sr.temporary = true;
