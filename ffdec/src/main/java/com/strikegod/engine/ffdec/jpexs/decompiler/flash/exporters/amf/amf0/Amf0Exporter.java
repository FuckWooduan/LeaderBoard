 ...
 */
package com.strikegod.engine.ffdec.jpexs.decompiler.flash.exporters.amf.amf0;

import com.strikegod.engine.ffdec.jpexs.decompiler.flash.amf.amf0.types.ArrayType;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.amf.amf0.types.BasicType;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.amf.amf0.types.ComplexObject;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.amf.amf0.types.DateType;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.amf.amf0.types.EcmaArrayType;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.amf.amf0.types.ObjectType;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.amf.amf0.types.ReferenceType;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.amf.amf0.types.TypedObjectType;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.amf.amf0.types.XmlDocumentType;
...
public class Amf0Exporter {
     ...
     */
    public static String amfMapToString(Map<String, Object> map, int level, String newLine) {
    ...
    public static String amfToString(
        ...
        if (value instanceof ObjectType) {
            ...
            sb.append(addId);
            membersToString(
                    "members", sb, ot.properties, level + 1, newLine, processedObjects, referenceCount, objectAlias);
            sb.append(newLine);
            sb.append(indent(level)).append("}");
            return sb.toString();
        }
        ...
        if (value instanceof TypedObjectType) {
            ...
            sb.append(indent(level + 1))
                    .append("\"className\": \"")
                    .append(Helper.escapeActionScriptString(tot.className))
                    .append("\",")
                    .append(newLine);
            membersToString(
                    "members", sb, tot.properties, level + 1, newLine, processedObjects, referenceCount, objectAlias);
            sb.append(newLine);
            sb.append(indent(level)).append("}");
            return sb.toString();
        }
        ...
        if (value instanceof DateType) {
            ...
            sb.append(indent(level + 1))
                    .append("\"value\": \"")
                    .append(sdf.format(dt.toDate()))
                    .append("\",")
                    .append(newLine);
            sb.append(indent(level + 1))
                    .append("\"timezone\": ")
                    .append(dt.getTimezone())
                    .append(newLine);
            sb.append(indent(level)).append("}");
            return sb.toString();
        }
        ...
        if (value instanceof XmlDocumentType) {
            ...
            sb.append(indent(level + 1))
                    .append("\"value\": \"")
                    .append(Helper.escapeActionScriptString(xdt.getData()))
                    .append("\"")
                    .append(newLine);
            sb.append(indent(level)).append("}");
            return sb.toString();
    ...
    public static void populateObjects(
            ...
            Map<Object, String> objectAlias) {
        if (((List<? extends Class>) Arrays.asList(String.class, Double.class, BasicType.class, Boolean.class))
