 ...
 */
package com.strikegod.engine.ffdec.jpexs.decompiler.flash.abc.avm2.model.clauses;
...
public class DeclarationAVM2Item extends AVM2Item {
    ...
    public GraphTextWriter appendTo(GraphTextWriter writer, LocalData localData) throws InterruptedException {
        ...
        if (assignment instanceof LocalRegAVM2Item) { // for..in
            ...
            String localName = localRegName(
                    localData.abc.getSwf(), localData.localRegNames, lti.regIndex, localData.usedDeobfuscations);
        ...
        if (assignment instanceof SetPropertyAVM2Item) {
            ...
            writer.append(IdentifiersDeobfuscation.printIdentifier(
                    localData.abc.getSwf(),
                    localData.usedDeobfuscations,
                    true,
                    ((FullMultinameAVM2Item) spti.propertyName).resolvedMultinameName));
            writer.append(":");
