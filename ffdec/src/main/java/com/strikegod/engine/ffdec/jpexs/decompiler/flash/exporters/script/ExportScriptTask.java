...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.RunnableIOExResult;
        ...
        RunnableIOExResult<File> rio = new RunnableIOExResult<File>() {
            ...
            public void run() throws IOException, InterruptedException {
                ...
                try (FileTextWriter writer = exportSettings.singleFile
                        ? null
                        : new FileTextWriter(Configuration.getCodeFormatting(), new FileOutputStream(f))) {
