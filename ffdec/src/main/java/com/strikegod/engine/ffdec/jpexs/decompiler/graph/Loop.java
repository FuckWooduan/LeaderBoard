...
public class Loop implements Serializable {
    ...
    public String toString() {
        ...
        return "loop(id:" + id + (loopPreContinue != null ? ",precontinue:" + loopPreContinue : "") + ",continue:"
                + loopContinue + ", break:" + loopBreak + ", phase:" + phase + ", backedges: "
                + String.join(",", edgesAsStr) + ", breakCandidates: " + String.join(",", bcAsStr) + ")";
    }
