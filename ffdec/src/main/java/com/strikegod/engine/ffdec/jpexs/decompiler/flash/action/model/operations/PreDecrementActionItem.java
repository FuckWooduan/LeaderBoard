 ...
 */
package com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.model.operations;
...
import com.strikegod.engine.ffdec.jpexs.decompiler.graph.model.UnaryOpItem;
...
public class PreDecrementActionItem extends UnaryOpItem {
    ...
    public PreDecrementActionItem(GraphSourceItem instruction, GraphSourceItem lineStartIns, GraphTargetItem object) {
        super(
                ...
                object,
                "--",
                "" /*"Number" Causes unnecessary ++Number(xx) when xx not number*/);
    }
    ...
    private List<GraphSourceItem> toSourceBoth(
            SourceGeneratorLocalData localData, SourceGenerator generator, boolean wantResult)
            throws CompilationException {
        ...
        if (val instanceof GetVariableActionItem) {
            ...
            if (mem.isGetter) {
                ...
                ret.addAll(toSourceMerge(localData, generator, mem, new ActionDecrement()));
                ret.addAll(toSourceMerge(
                        localData,
                        generator,
        ...
        } else if ((val instanceof DirectValueActionItem)
                && ((DirectValueActionItem) val).value instanceof RegisterNumber) {
