...
public class Namespace {
     ...
     * Namespace kinds
     */
    public static final int[] nameSpaceKinds = new int[] {
        KIND_NAMESPACE,
        KIND_PRIVATE,
        KIND_PACKAGE,
     ...
     */
    public static final String[] nameSpaceKindNames = new String[] {
        "Namespace",
        "PrivateNamespace",
        "PackageNamespace",
        "PackageInternalNs",
     ...
     * Namespace prefixes
     */
    public static final String[] namePrefixes =
            new String[] {"", "private", "public", "internal", "protected", "explicit", "protected"};
