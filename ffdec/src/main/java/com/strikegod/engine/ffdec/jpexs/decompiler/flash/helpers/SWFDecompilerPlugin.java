/*
 *  Copyright (C) 2010-2026 JPEXS, Miron Sadziak, All rights reserved.
 *
 ...
 */
package com.strikegod.engine.ffdec.jpexs.decompiler.flash.helpers;
...
import com.strikegod.engine.ffdec.jpexs.helpers.plugin.CharSequenceJavaFileObject;
import com.strikegod.engine.ffdec.jpexs.helpers.plugin.ClassFileManager;
import java.io.File;
...
public class SWFDecompilerPlugin {
    ...
    public static File getPluginsDir() {
        ...
        try {
            ...
            if (pluginPath == null || !pluginPath.exists()) {
                File f = new File(SWFDecompilerPlugin.class
                        .getProtectionDomain()
                        .getCodeSource()
                        .getLocation()
                        .toURI()
    ...
    private static void loadPluginCompiled(String path) {
        ...
        try {
            ...
            if (SWFDecompilerListener.class.isAssignableFrom(cls)) {
                SWFDecompilerListener listener =
                        (SWFDecompilerListener) cls.getDeclaredConstructor().newInstance();
    ...
    private static void loadPluginSource(String path) {
        ...
        try {
            listeners.add((SWFDecompilerListener) fileManager
                    .getClassLoader(null)
                    .loadClass(fullName)
     ...
     * @throws InterruptedException On interrupt
     */
    public static boolean fireAvm2CodeRemoveTraps(
            String path,
            int classIndex,
            boolean isStatic,
            int scriptIndex,
