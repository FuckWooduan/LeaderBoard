...
public class DefineSoundTag extends CharacterTag implements SoundTag {
    ...
    @EnumValue(
            value = SoundFormat.FORMAT_UNCOMPRESSED_LITTLE_ENDIAN,
            text = "Uncompressed, little-endian",
            minSwfVersion = 4)
    ...
    public SoundExportFormat getExportFormat() {
        ...
        if (soundFormat == SoundFormat.FORMAT_NELLYMOSER
                || soundFormat == SoundFormat.FORMAT_NELLYMOSER16KHZ
                || soundFormat == SoundFormat.FORMAT_NELLYMOSER8KHZ) {
            return SoundExportFormat.WAV;
        }
