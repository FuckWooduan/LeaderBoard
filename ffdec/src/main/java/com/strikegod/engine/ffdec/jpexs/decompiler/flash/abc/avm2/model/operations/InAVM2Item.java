...
public class InAVM2Item extends BinaryOpItem {
     ...
     */
    public InAVM2Item(
            GraphSourceItem instruction, GraphSourceItem lineStartIns, GraphTargetItem name, GraphTargetItem object) {
        super(
    ...
    public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData, SourceGenerator generator)
        ...
        return toSourceMerge(
                localData, generator, leftSide, rightSide, new AVM2Instruction(0, AVM2Instructions.In, null));
    }
