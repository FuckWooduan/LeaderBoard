...
public class SetPropertyAVM2Item extends AVM2Item implements SetTypeAVM2Item, AssignmentAVM2Item {
    ...
    public GraphTargetItem getObject() {
        return new GetPropertyAVM2Item(
                getInstruction(), getLineStartIns(), object, propertyName, type, callType, isStatic);
    }
    ...
    public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData, SourceGenerator generator)
        ...
        return toSourceMerge(
                localData, generator, object, value, new AVM2Instruction(0, AVM2Instructions.SetProperty, new int[] {
