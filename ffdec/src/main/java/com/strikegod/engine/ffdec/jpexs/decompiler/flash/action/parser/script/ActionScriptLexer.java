...
public final class ActionScriptLexer {
     ...
     */
    private static final int ZZ_LEXSTATE[] = {0, 0, 1, 1, 2, 2, 3, 3, 3, 3, 4, 4};

    /**
     * Translates characters to character classes
     */
    private static final String ZZ_CMAP_PACKED = "\11\7\1\3\1\2\1\126\1\127\1\1\16\7\4\0\1\3\1\113"
    ...
    private static final String ZZ_ACTION_PACKED_0 =
            "\5\0\1\1\2\2\1\3\1\4\1\5\1\6\1\7" + "\2\10\1\6\1\11\1\12\1\13\1\14\36\6\1\15"
    ...
    private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\131\0\262\0\u010b\0\u0164\0\u01bd\0\u0216\0\u01bd"
    ...
    private static final String ZZ_TRANS_PACKED_0 =
            "\1\6\1\7\1\10\1\11\1\12\1\13\1\14\1\6" + "\1\15\1\16\1\17\2\14\1\17\1\20\1\21\1\22"
    ...
    private static final String ZZ_ATTRIBUTE_PACKED_0 =
            "\5\0\1\11\1\1\1\11\11\1\2\11\37\1\10\11" + "\4\1\3\11\5\1\1\11\3\1\2\11\3\1\1\11"
        ...
        while (true) {
            ...
            switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
                ...
                case 8: {
                    try {
                        return new ParsedSymbol(
                                yychar(), SymbolGroup.INTEGER, SymbolType.INTEGER, Long.parseLong(yytext()));
                    } catch (NumberFormatException nfe) {
                        // its too long for a Long var
                        return new ParsedSymbol(
                                yychar(), SymbolGroup.DOUBLE, SymbolType.DOUBLE, Double.parseDouble(yytext()));
                    }
                }
                case 188:
                    break;
                ...
                case 38: {
                    ...
                    // length also includes the trailing quote
                    return new ParsedSymbol(
                            itemStart, SymbolGroup.IDENTIFIER, SymbolType.IDENTIFIER, string.toString());
                }
                case 218:
                    break;
                case 39: {
                ...
                case 43: {
                    return new ParsedSymbol(
                            yychar(), SymbolGroup.INTEGER, SymbolType.INTEGER, Long.parseLong(yytext(), 8));
                }
                case 223:
                    break;
                case 44: {
                ...
                case 64: {
                    return new ParsedSymbol(
                            yychar(), SymbolGroup.DIRECTIVE, SymbolType.DIRECTIVE, yytext().substring(1));
                }
                case 244:
                    break;
                case 65: {
                ...
                case 74: {
                    throw new ActionParseException(
                            "Illegal escape sequence \"" + yytext() + "\"", yyline + 1, yychar());
                }
                case 254:
                    break;
                case 75: {
                ...
                case 83: {
                    return new ParsedSymbol(
                            ...
                            SymbolGroup.INTEGER,
                            SymbolType.INTEGER,
                            Long.parseLong(yytext().substring(2), 16));
                }
                case 263:
                    break;
                case 84: {
