...
public class SoundStreamHeadTag extends SoundStreamHeadTypeTag {
    ...
    public SoundExportFormat getExportFormat() {
        ...
        if (streamSoundCompression == SoundFormat.FORMAT_NELLYMOSER
                || streamSoundCompression == SoundFormat.FORMAT_NELLYMOSER16KHZ
                || streamSoundCompression == SoundFormat.FORMAT_NELLYMOSER8KHZ) {
            return SoundExportFormat.WAV;
        }
