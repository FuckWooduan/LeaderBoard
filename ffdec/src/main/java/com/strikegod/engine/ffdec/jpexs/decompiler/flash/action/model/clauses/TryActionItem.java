 ...
 */
package com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.model.clauses;
...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.action.parser.script.ActionSourceGenerator;
...
public class TryActionItem extends ActionItem implements Block {
     ...
     */
    public TryActionItem(
            List<GraphTargetItem> tryCommands,
    ...
    public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData, SourceGenerator generator)
        ...
        List<Action> finallyCommandsA = finallyCommands == null
                ? null
                : asGenerator.toActionList(asGenerator.generate(localData, finallyCommands));
        ...
        if (!catchCommands.isEmpty()) {
            ...
            if (catchExceptionNames.size() == 1
                    && catchExceptionTypes.get(0) == null) { // catch everything without any type
                ...
                if (ename instanceof DirectValueActionItem) {
                    ...
                    Logger.getLogger(TryActionItem.class.getName())
                            .log(Level.SEVERE, "Invalid catchName, string expected");
                }
                ...
                if (!allCatched) {
                    fullCatchBody.addAll(
                            0,
                            GraphTargetItem.toSourceMerge(
                                    localData,
                                    generator,
                ...
                for (int i = catchExceptionNames.size() - 1; i >= 0; i--) {
                    ...
                    if (etype == null) {
                        ...
                        List<GraphSourceItem> ifBody = GraphTargetItem.toSourceMerge(
                                localData, generator, ename, new ActionStackSwap(), new ActionDefineLocal(), ebody);
                        fullCatchBody.add(0, new ActionPop());
                        int toFinishSize = Action.actionsToBytes(
                                        asGenerator.toActionList(fullCatchBody), false, SWF.DEFAULT_VERSION)
                                .length;
