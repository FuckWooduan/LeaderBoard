    ...
    public void translate(
        ...
        if (v instanceof HasTempIndex) {
            ...
            stack.addToOutput(new SetTemporaryItem(
                    ActionGraphTargetDialect.INSTANCE, this, localData.lineStartInstruction, v, temp, "dup", 2));
            stack.finishBlock(output);

            stack.push(new DuplicateSourceItem(
                    ActionGraphTargetDialect.INSTANCE, this, localData.lineStartInstruction, v, temp));
        }
