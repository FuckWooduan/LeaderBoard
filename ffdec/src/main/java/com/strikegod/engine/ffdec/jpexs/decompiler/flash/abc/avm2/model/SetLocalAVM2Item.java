...
public class SetLocalAVM2Item extends AVM2Item implements SetTypeAVM2Item, AssignmentAVM2Item {
    ...
    public GraphTextWriter appendTo(GraphTextWriter writer, LocalData localData) throws InterruptedException {
        String localName =
                localRegName(localData.abc.getSwf(), localData.localRegNames, regIndex, localData.usedDeobfuscations);
    ...
    public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData, SourceGenerator generator)
        ...
        return toSourceMerge(localData, generator, value, new AVM2Instruction(0, AVM2Instructions.Dup, null), ins);
    }
