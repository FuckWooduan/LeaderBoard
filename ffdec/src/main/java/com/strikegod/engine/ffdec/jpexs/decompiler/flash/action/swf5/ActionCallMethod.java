...
public class ActionCallMethod extends Action {
    ...
    public ActionCallMethod() {
        super(0x52, 0, Utf8Helper.charsetName);
    }
        ...
        if (methodName instanceof DirectValueActionItem) {
            ...
            if (dv.isString()) {
                ...
                if (methodNameStr.startsWith("__get__") && args.isEmpty()) {
                    ...
                    GetMemberActionItem gm = new GetMemberActionItem(
                            this, lineStartAction, scriptObject, new DirectValueActionItem(varName));
                    gm.isGetter = true;
                    stack.push(gm);
                    return;
                    ...
                    ActionSetMember.handleSetMember(
                            true,
                            args.get(0),
                            new DirectValueActionItem(varName),
                            scriptObject,
                            this,
                            usedDeobfuscations,
