...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.abc.avm2.parser.script.NamespaceItem;
...
public class InitVectorAVM2Item extends AVM2Item {
     ...
     */
    public InitVectorAVM2Item(
            GraphTargetItem subtype, List<GraphTargetItem> arguments, List<NamespaceItem> openedNamespaces) {
                    ...
                    ins(
                            ...
                            constants.getMultinameId(
                                    Multiname.createMultinameL(
                                            false, NamespaceItem.getCpoolSetIndex(g.abcIndex, openedNamespaces)),
                                    true))));
        }
        return ret;
    }
