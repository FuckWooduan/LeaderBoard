...
public abstract class ABCWalker {
    ...
    public final void walkABC(ABC abc, boolean walkOrphanItems) {
        ...
        if (walkOrphanItems) {
            ...
            for (int i = 0; i < abc.class_info.size(); i++) {
                optionalHandleClass(
                        handledClasses, handledMethodBodies, handledMethodInfos, abc, i, -1, -1, -1, WalkType.Orphan);
            }
        }
    }
     ...
     */
    private boolean optionalHandleClass(
            Set<Integer> handledClasses,
            Set<Integer> handledMethodBodies,
            Set<Integer> handledMethodInfos,
            ABC abc,
            int index,
            int scriptIndex,
        ...
        optionalHandleMethodInfo(
                ...
                handledMethodInfos,
                abc,
                abc.instance_info.get(index).iinit_index,
                scriptIndex,
                scriptTraitIndex,
                index,
                -1,
        ...
        walkTraits(
                abc,
                abc.instance_info.get(index).instance_traits,
                scriptIndex,
                scriptTraitIndex,
                index,
                -1,
        ...
        optionalHandleMethodInfo(
                ...
                handledMethodInfos,
                abc,
                abc.class_info.get(index).cinit_index,
                scriptIndex,
                scriptTraitIndex,
                index,
                -1,
        ...
        walkTraits(
                abc,
                abc.class_info.get(index).static_traits,
                scriptIndex,
                scriptTraitIndex,
                index,
                -1,
     ...
     */
    private void optionalHandleMethodInfo(
            Set<Integer> handledMethodBodies,
            Set<Integer> handledMethodInfos,
            ABC abc,
            int index,
        ...
        handleMethodInfo(
                abc, index, scriptIndex, scriptTraitIndex, classIndex, traitIndex, walkType, initializer, callStack);
     ...
     * @param callStack Call stack
     */
    private void optionalHandleMethodBody(
            Set<Integer> handledMethodBodies,
            Set<Integer> handledMethodInfos,
            ABC abc,
            int index,
        ...
        for (int i = 0; i < traits.traits.size(); i++) {
            ...
            if ((t.kindFlags & Trait.ATTR_Metadata) > 0) {
                for (int m = 0; m < t.metadata.length; m++) {
                    handleMetadataInfo(
                            abc, t.metadata[m], t, scriptIndex, scriptTraitIndex, classIndex, i, m, walkType);
                }
            }
     ...
     * @param initializer Initializer
     */
    protected void handleMethodBody(
            ABC abc,
            int index,
            int scriptIndex,
            int classIndex,
