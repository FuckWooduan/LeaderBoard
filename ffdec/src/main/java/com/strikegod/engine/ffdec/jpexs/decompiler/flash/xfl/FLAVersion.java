...
public enum FLAVersion {
    F5("F5", "Flash 5", null, 5),
    MX("MX", "Flash MX", null, 6),
    MX2004("MX2004", "Flash MX 2004", null, 7),
    F8("F8", "Flash 8", null, 8),
    CS3("CS3", "Flash CS 3", null, 9),
    CS4("CS4", "Flash CS 4", null, 10),
    ...
    public Object getCfbFlaVersion() {
        return null;
    }
