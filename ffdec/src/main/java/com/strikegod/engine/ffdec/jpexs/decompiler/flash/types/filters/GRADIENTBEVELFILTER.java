...
public class GRADIENTBEVELFILTER extends FILTER {
    ...
    public RGBA[] gradientColors = new RGBA[] {new RGBA(Color.WHITE), new RGBA(255, 0, 0, 0), new RGBA(Color.BLACK)};
    ...
    public int[] gradientRatio = new int[] {0, 128, 255};
    ...
    public SerializableImage apply(SerializableImage src, double zoom, int srcX, int srcY, int srcW, int srcH) {
        ...
        return Filtering.gradientBevel(
                src,
                colorsArr,
                ratiosArr,
                (int) Math.round(blurX * zoom),
                (int) Math.round(blurY * zoom),
                strength,
                type,
