...
public class BitNotAVM2Item extends UnaryOpItem {
    ...
    public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData, SourceGenerator generator)
        ...
        return toSourceMerge(localData, generator, value, new AVM2Instruction(0, AVM2Instructions.BitNot, null));
    }
    ...
    @Override
    protected void operandToString(GraphTargetItem operand, GraphTextWriter writer, LocalData localData)
