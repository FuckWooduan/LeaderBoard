...
public class TraitSlotConst extends Trait implements TraitWithSlot {
    ...
    public String getType(
        ...
        if (type_index > 0) {
            typeStr = constants
                    .getMultiname(type_index)
                    .getName(usedDeobfuscations, abc, constants, fullyQualifiedNames, false, true);
        }
        return typeStr;
    }
     ...
     * @return Writer
     */
    public GraphTextWriter getNameStr(
            GraphTextWriter writer, ABC abc, List<DottedChain> fullyQualifiedNames, Set<String> usedDeobfuscations) {
        ...
        writer.hilightSpecial(
                getName(abc).getName(usedDeobfuscations, abc, abc.constants, new ArrayList<>(), false, true),
    ...
    public String toString(ABC abc, List<DottedChain> fullyQualifiedNames) {
        ...
        return "0x" + Helper.formatAddress(fileOffset) + " " + Helper.byteArrToString(bytes) + " SlotConst "
                ...
                + slot_id + " type=" + typeStr + " value=" + (new ValueKind(value_index, value_kind)).toString(abc)
    ...
    public void getDependencies(
        ...
        DependencyParser.parseDependenciesFromMultiname(
                ...
                abc,
                dependencies,
                abc.constants.getMultiname(type_index),
                getPackage(abc),
                fullyQualifiedNames,
    ...
    public GraphTextWriter convertTraitHeader(ABC abc, GraphTextWriter writer) {
        ...
        if (value_kind != ValueKind.CONSTANT_Undefined) {
            ...
            writer.hilightSpecial(
                    (new ValueKind(value_index, value_kind).toASMString(abc)), HighlightSpecialType.TRAIT_VALUE);
            writer.newLine();
        }
        return writer;
    }
