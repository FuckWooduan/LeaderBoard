...
public class ButtonAction implements ASMSource {
    ...
    public GraphTextWriter getActionScriptSource(
        ...
        return Action.actionsToSource(
                new HashMap<>(), this, actions, getScriptName(), writer, buttonTag.getCharset(), treeOperations);
    }
    ...
    public GraphTextWriter getActionBytesAsHex(GraphTextWriter writer) {
        return Helper.byteArrayToHexWithHeader(
                writer, buttonTag.getActionBytes().getRangeData());
    }
    ...
    public List<GraphTargetItem> getActionsToTree() {
        try {
            return Action.actionsToTree(
                    ...
                    false,
                    getActions(),
                    buttonTag.getSwf().version,
                    0,
                    getScriptName(),
                    buttonTag.getSwf().getCharset());
