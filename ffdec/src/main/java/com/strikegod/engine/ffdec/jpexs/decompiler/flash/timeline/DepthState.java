...
public class DepthState {
    ...
    public boolean cacheAsBitmap() {
        return (placeObjectTag != null && placeObjectTag.cacheAsBitmap()) || (filters != null && !filters.isEmpty());
    }
    ...
    public PlaceObjectTypeTag toPlaceObjectTag(int depth) {
        if (minPlaceObjectNum <= 1) {
            ...
            return new PlaceObject2Tag(
                    swf, false, depth, characterId, matrix, cxForm, ratio, instanceName, clipDepth, clipActions);
