...
public class PrintNumActionItem extends ActionItem {
    ...
    private List<GraphSourceItem> toSource(
        ...
        if (boundingBox instanceof DirectValueActionItem) {
            ...
            if (directValue.isString() && "bmovie".equals(directValue.getAsString())) {
                return toSourceMerge(
                        localData,
                        generator,
                        asGenerator.pushConstTargetItem("print:"),
                        lev,
                        new ActionGetURL2(0, false, false, charset),
                        needsReturn
        ...
        return toSourceMerge(
                ...
                generator,
                new AddActionItem(
                        getSrc(), getLineStartItem(), asGenerator.pushConstTargetItem("print:#"), boundingBox, true),
                lev,
                new ActionGetURL2(0, false, false, charset),
