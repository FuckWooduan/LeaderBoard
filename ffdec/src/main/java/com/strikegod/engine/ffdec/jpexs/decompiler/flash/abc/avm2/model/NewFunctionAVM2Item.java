...
public class NewFunctionAVM2Item extends AVM2Item {
    ...
    public GraphTextWriter appendTo(GraphTextWriter writer, LocalData localData) throws InterruptedException {
        ...
        abc.method_info
                .get(methodIndex)
                .getParamStr(
                        writer, abc.constants, body, abc, localData.fullyQualifiedNames, localData.usedDeobfuscations);
        writer.appendNoHilight("):");
        ...
        abc.method_info
                .get(methodIndex)
                .getReturnTypeStr(
                        writer, abc, abc.constants, localData.fullyQualifiedNames, localData.usedDeobfuscations);
        writer.startBlock();
        if (body != null) {
            ...
            body.convert(
                    ...
                    null,
                    false,
                    new HashSet<>(localData.seenMethods),
                    new ArrayList<>(),
