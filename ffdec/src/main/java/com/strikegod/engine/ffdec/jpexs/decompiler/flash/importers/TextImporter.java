...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.base.TextImportErrorHandler;
...
public class TextImporter {
    ...
    private Map<Integer, String[]> splitTextRecords(String texts) {
        String[] textsArr =
                texts.split(Helper.newLine + Configuration.textExportSingleFileSeparator.get() + Helper.newLine);
        String recordSeparator =
                Helper.newLine + Configuration.textExportSingleFileRecordSeparator.get() + Helper.newLine;
