...
public abstract class ActionItem extends GraphTargetItem implements Serializable {
     ...
     */
    public ActionItem(
            GraphSourceItem instruction, GraphSourceItem lineStartIns, int precedence, GraphTargetItem value) {
    ...
    protected List<GraphSourceItem> toSourceCall(
            SourceGeneratorLocalData localData, SourceGenerator gen, List<GraphTargetItem> list)
