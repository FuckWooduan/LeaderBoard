...
public final class PathArea {
     ...
     * vertices.
     */
    private static void orientationOfClosedRing(
            List<double[]> pts, Reference<Double> areaRef, Reference<Orientation> resultRef) {
    ...
    public static void orientationSingleClosed(
            Shape shape, Reference<Orientation> orientationRef, Reference<Double> areaRef) {
