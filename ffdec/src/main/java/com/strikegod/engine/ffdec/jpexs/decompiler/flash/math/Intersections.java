...
public class Intersections {
    ...
    private static void tesselateInterior(
            double flatness, Point2D zeroVector, Point2D p1, Point2D p2, Point2D p3, List<Point2D> points) {
        // round 1
     ...
     */
    public static List<Point2D> intersectBezier2Bezier2Slow(
            Point2D a1, Point2D a2, Point2D a3, Point2D b1, Point2D b2, Point2D b3) {
    ...
    public static List<Point2D> intersectBezier2Bezier2(
        ...
        Polynomial poly = new Polynomial(
                Arrays.asList(-e * e, -2 * e * f, a * b - f * f - 2 * e * g, a * c - 2 * f * g, a * d - g * g));
        ...
        for (double s : roots) {
            if (0 <= s && s <= 1) {
                Polynomial xp = new Polynomial(Arrays.asList(
                        c12.getX(), c11.getX(), c10.getX() - c20.getX() - s * c21.getX() - s * s * c22.getX()));
                xp.simplifyEquals();
                List<Double> xRoots = xp.getRoots();
                Polynomial yp = new Polynomial(Arrays.asList(
                        c12.getY(), c11.getY(), c10.getY() - c20.getY() - s * c21.getY() - s * s * c22.getY()));
                yp.simplifyEquals();
    ...
    public static List<Point2D> intersectBezier2Line(Point2D p1, Point2D p2, Point2D p3, Point2D a1, Point2D a2) {
        ...
        // of cubic
        List<Double> roots = new Polynomial(Arrays.asList(dot(n, c2), dot(n, c1), dot(n, c0) + cl)).getRoots();
    ...
    public static List<Point2D> intersectLineLine(
            Point2D a1, Point2D a2, Point2D b1, Point2D b2, boolean addCoincident) {
        List<Point2D> result = new ArrayList<>();

        double ua_t =
                (b2.getX() - b1.getX()) * (a1.getY() - b1.getY()) - (b2.getY() - b1.getY()) * (a1.getX() - b1.getX());
        double ub_t =
                (a2.getX() - a1.getX()) * (a1.getY() - b1.getY()) - (a2.getY() - a1.getY()) * (a1.getX() - b1.getX());
        double u_b =
                (b2.getY() - b1.getY()) * (a2.getX() - a1.getX()) - (b2.getX() - b1.getX()) * (a2.getY() - a1.getY());
        ...
        if (u_b != 0) {
            ...
            if (0 <= ua && ua <= 1 && 0 <= ub && ub <= 1) {
                result.add(new Point2D.Double(
                        a1.getX() + ua * (a2.getX() - a1.getX()), a1.getY() + ua * (a2.getY() - a1.getY())));
            } else {
                // No Intersection
            }
