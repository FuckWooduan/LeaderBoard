...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.iggy.IggyCharAdvances;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.iggy.IggyCharKerning;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.iggy.IggyDeclStrings;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.iggy.IggyFile;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.iggy.IggyFont;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.iggy.IggyShape;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.iggy.IggySwf;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.iggy.IggyText;
    ...
    public static SWF getSwf(IggyFile file) {
        ...
        for (int fontIndex = 0; fontIndex < iggySwf.getFonts().size(); fontIndex++) {
            ...
            for (int i = 0; i < iggyFont.getCharacterCount(); i++) {
                ...
                fontTag.fontAdvanceTable.add(
                        makeLengthsEm(advanceValues.getScales().get(i)));
            }
        ...
        if (declStrings != null) {
            ...
            try {
                DoABC2Tag nabc =
                        new DoABC2Tag(new SWFInputStream(swf, fullAbcTagData), new ByteArrayRange(fullAbcTagData));
