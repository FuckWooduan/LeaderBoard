...
public class As12PCodeDocs extends AbstractDocs {
    ...
    private static List<String> allInstructionNames = Arrays.asList(
            "gotoframe",
            "geturl",
            "nextframe",
            "prevframe",
    ...
    static {
        prop = ResourceBundle.getBundle("com.strikegod.engine.ffdec.jpexs.decompiler.flash.locales.docs.pcode.AS2");
    }
    ...
    public static String getDocsForIns(
            String insName, boolean ui, boolean standalone, boolean nightMode, int argumentToHilight) {
        ...
        sb.append("<div class=\"stack\"><strong class=\"stack-title\">")
                ...
                .append("</div>")
                .append(NEWLINE);
        sb.append("<div class=\"swfVersion\"><strong class=\"swfVersion-title\">")
                .append(getProperty("ui.swfVersion"))
                .append("</strong><span class=\"swfVersion-value\">")
                .append(swfVersion)
                .append("</span>")
                .append("</div>")
                .append(NEWLINE);
    ...
    public static String getJs() {
        ...
        String js = "";
        InputStream is = As12PCodeDocs.class.getResourceAsStream(
                "/com/strikegod/engine/ffdec/jpexs/decompiler/flash/docs/docs.js");
        if (is == null) {
            Logger.getLogger(As12PCodeDocs.class.getName())
    ...
    public static String getAllInstructionDocs(boolean nightMode) {
        ...
        for (String name : s) {
            ...
            sb.append("\t\t\t\t")
                    .append(getDocsForIns(name, false, false, nightMode, -1)
                            .trim()
