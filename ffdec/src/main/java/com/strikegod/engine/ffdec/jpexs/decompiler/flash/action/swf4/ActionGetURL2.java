...
public class ActionGetURL2 extends Action {
    ...
    public ActionGetURL2(FlasmLexer lexer, String charset) throws IOException, ActionParseException {
        ...
        if (symb.type
                == ASMParsedSymbol
                        .TYPE_BOOLEAN) { // backwards compatibility. In 19.1.0 up to 20.0.0 sendVarsMethod is first
    ...
    public void translate(
        ...
        if (loadVariablesFlag) {
            if (num != null) {
                stack.addToOutput(
                        new LoadVariablesNumActionItem(this, lineStartAction, urlString, num, sendVarsMethod));
            } else {
                stack.addToOutput(
                        new LoadVariablesActionItem(this, lineStartAction, urlString, targetString, sendVarsMethod));
            }
            ...
            if ((urlString instanceof DirectValueActionItem) && ("".equals(urlString.getResult()))) {
                ...
                stack.addToOutput(
                        new LoadMovieActionItem(this, lineStartAction, urlString, targetString, sendVarsMethod));
            }
        } else {
            ...
            if (num != null) {
                if (doUnload) {
                    ...
                    stack.addToOutput(
                            new LoadMovieNumActionItem(this, lineStartAction, urlString, num, sendVarsMethod));
                }
            } else if (doPrint) {
                ...
                stack.addToOutput(
                        new GetURL2ActionItem(this, lineStartAction, urlString, targetString, sendVarsMethod));
            }
        }
    }
