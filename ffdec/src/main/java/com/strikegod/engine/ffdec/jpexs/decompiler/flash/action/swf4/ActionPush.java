...
public class ActionPush extends Action {
     ...
     */
    public ActionPush(FlasmLexer lexer, List<String> constantPool, String charset)
            ...
            switch (symb.type) {
                ...
                default:
                    throw new ActionParseException(
                            "Arguments expected, " + symb.type + " " + symb.value + " found", lexer.yyline());
            }
        }
    }
    ...
    public GraphTextWriter paramsToStringReplaced(
            List<? extends GraphSourceItem> container,
            ...
            if (toPush == null) {
                if (o instanceof Boolean) {
                    ...
                    if (dvt.computedRegValue instanceof TemporaryRegister) {
                        ...
                        toPush = new TemporaryRegister(
                                ((RegisterNumber) o).number, ((TemporaryRegister) dvt.computedRegValue).value);
                    } else {
                        toPush = dvt;
                    }
                }
