    ...
    public GraphTextWriter appendTo(GraphTextWriter writer, LocalData localData) throws InterruptedException {
        ...
        if ((memberName instanceof DirectValueActionItem) && printObfuscatedMemberName) {
            ...
            writer.append(IdentifiersDeobfuscation.printIdentifier(
                    localData.swf, localData.usedDeobfuscations, false, sb.toString()));
            return writer;
        }
        if (((!(memberName instanceof DirectValueActionItem))
                || (!((DirectValueActionItem) memberName).isString())
                || (!printObfuscatedMemberName
                        && !IdentifiersDeobfuscation.isValidName(
                                false, ((DirectValueActionItem) memberName).toStringNoQuotes(localData))))) {
            writer.append("[");
    ...
    public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData, SourceGenerator generator)
        ...
        if (isGetter) {
            ...
            return toSourceMerge(
                    ...
                    object,
                    asGenerator.pushConst("__get__" + memberNameAsStr),
