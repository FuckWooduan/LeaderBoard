 ...
 */
package com.strikegod.engine.ffdec.jpexs.decompiler.flash.flv;
...
public class SCRIPTDATA extends DATA {
     ...
     * @return Script data
     */
    public static SCRIPTDATA simpleVideOnMetadata(
            double duration, double width, double height, double framerate, double videocodecid) {
     ...
     * @return Script data
     */
    public static SCRIPTDATA onMetaData(
            double duration,
            double width,
            double height,
