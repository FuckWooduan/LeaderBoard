...
public class TernarOpItem extends GraphTargetItem {
    ...
    public GraphTextWriter appendTo(GraphTextWriter writer, LocalData localData) throws InterruptedException {
        ...
        if (onTrue.getPrecedence() >= precedence
                && onTrue.getPrecedence()
                        != GraphTargetItem.NOPRECEDENCE) { // >= ternar in ternar better in parenthesis
            writer.append("(");
        }
    ...
    public GraphTargetItem returnType() {
        ...
        if ((onTrueType.equals(TypeItem.NUMBER) || onTrueType.equals(TypeItem.INT) || onTrueType.equals(TypeItem.UINT))
                && (onFalseType.equals(TypeItem.NUMBER)
                        || onFalseType.equals(TypeItem.INT)
                        || onFalseType.equals(TypeItem.UINT))) {
