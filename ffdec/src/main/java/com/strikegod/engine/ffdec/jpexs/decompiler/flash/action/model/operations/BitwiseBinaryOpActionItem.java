...
public abstract class BitwiseBinaryOpActionItem extends BinaryOpItem implements CompoundableBinaryOpAs12 {
     ...
     */
    public BitwiseBinaryOpActionItem(
    ...
    protected void operandToString(GraphTargetItem operand, GraphTextWriter writer, LocalData localData)
        ...
        if ((operand instanceof DirectValueActionItem)
                && ((((DirectValueActionItem) operand).value instanceof Long)
                        || (((DirectValueActionItem) operand).value instanceof Double)
                        || (((DirectValueActionItem) operand).value instanceof Float))) {
