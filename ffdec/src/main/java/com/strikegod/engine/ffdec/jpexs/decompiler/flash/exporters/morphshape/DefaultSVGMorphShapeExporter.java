...
public abstract class DefaultSVGMorphShapeExporter extends MorphShapeExporterBase {
     ...
     * @param zoom Zoom
     */
    public DefaultSVGMorphShapeExporter(
            int morphShapeNum, SHAPE shape, SHAPE endShape, ColorTransform colorTransform, double zoom) {
    ...
    public void moveTo(double x, double y, double x2, double y2) {
        currentDrawCommand = "";
        pathData.append("M")
                .append(roundPixels20(x * zoom / SWF.unitDivisor))
                .append(" ")
                .append(roundPixels20(y * zoom / SWF.unitDivisor))
                .append(" ");
        pathDataEnd
                .append("M")
                .append(roundPixels20(x2 * zoom / SWF.unitDivisor))
                .append(" ")
                .append(roundPixels20(y2 * zoom / SWF.unitDivisor))
                .append(" ");
    }
    ...
    public void curveTo(
        ...
        pathData.append(roundPixels20(controlX * zoom / SWF.unitDivisor))
                .append(" ")
                .append(roundPixels20(controlY * zoom / SWF.unitDivisor))
                .append(" ")
                .append(roundPixels20(anchorX * zoom / SWF.unitDivisor))
                .append(" ")
                .append(roundPixels20(anchorY * zoom / SWF.unitDivisor))
                .append(" ");
        pathDataEnd
                .append(roundPixels20(controlX2 * zoom / SWF.unitDivisor))
                .append(" ")
                .append(roundPixels20(controlY2 * zoom / SWF.unitDivisor))
                .append(" ")
                .append(roundPixels20(anchorX2 * zoom / SWF.unitDivisor))
                .append(" ")
                .append(roundPixels20(anchorY2 * zoom / SWF.unitDivisor))
                .append(" ");
    }
