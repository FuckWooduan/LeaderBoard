...
public final class Matrix implements Cloneable {
    ...
    public static Matrix getRotateInstance(double rotateAngle, double tx, double ty) {
        ...
        mat = mat.preConcatenate(getTranslateInstance(tx, ty)).concatenate(getTranslateInstance(-tx, -ty));
        return mat;
    }
    ...
    public Point deltaTransform(double x, double y) {
        Point result = new Point(scaleX * x + rotateSkew1 * y, rotateSkew0 * x + scaleY * y);
        return result;
    }
    ...
    public Point transform(double x, double y) {
        Point result = new Point(scaleX * x + rotateSkew1 * y + translateX, rotateSkew0 * x + scaleY * y + translateY);
        return result;
    }
    ...
    public AffineTransform toTransform() {
        AffineTransform transform =
                new AffineTransform(scaleX, rotateSkew0, rotateSkew1, scaleY, translateX, translateY);
        return transform;
    }
    ...
    public String getSvgTransformationString(double translateDivisor, double unitDivisor) {
        ...
        return "matrix(" + scaleX + ", " + rotateSkew0 + ", " + rotateSkew1 + ", " + scaleY + ", " + translateX + ", "
                + translateY + ")";
    }
    ...
    public String toString() {
        return "[Matrix scale:" + scaleX + "," + scaleY + ", rotate:" + rotateSkew0 + "," + rotateSkew1 + ", translate:"
