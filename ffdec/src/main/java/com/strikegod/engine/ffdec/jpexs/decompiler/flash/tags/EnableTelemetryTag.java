...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.base.PasswordTag;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.BasicType;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.annotations.HashType;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.annotations.Optional;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.annotations.Password;
...
public class EnableTelemetryTag extends Tag implements PasswordTag {
    ...
    public final void readData(
        ...
        if (sis.available() > 0) {
            if (sis.available() != 32) {
                Logger.getLogger(EnableTelemetryTag.class.getName())
                        .log(Level.WARNING, "PasswordHash should be 32 bytes");
            }
