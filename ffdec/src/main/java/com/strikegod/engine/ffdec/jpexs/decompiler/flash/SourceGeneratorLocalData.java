...
public class SourceGeneratorLocalData implements Serializable {
    ...
    public String getFullClass() {
        return pkg == null
                ? currentClassBaseName
                : pkg.addWithSuffix(currentClassBaseName).toRawString();
    }
     ...
     */
    public SourceGeneratorLocalData(
            HashMap<String, Integer> registerVars, Integer inFunction, Boolean inMethod, Integer forInLevel) {
