...
public class StringAVM2Item extends AVM2Item implements SimpleValue {
    ...
    public GraphTextWriter appendTo(GraphTextWriter writer, LocalData localData) {
        return writer.append("\"")
                .append(Helper.escapeActionScriptString(value))
                .append("\"");
    }
    ...
    public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData, SourceGenerator generator)
        ...
        return toSourceMerge(localData, generator, new AVM2Instruction(0, AVM2Instructions.PushString, new int[] {
            ((AVM2SourceGenerator) generator).str(value)
        }));
    }
