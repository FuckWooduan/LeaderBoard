            ...
            if (t instanceof IfItem) {
                ...
                if (ifItem.expression instanceof NotItem) {
                    ...
                    if (isMemberOfPath(condType, pathToSearchVariant1, newMemberNameRef)) {
                        ...
                        // _global.a.b.c = new Object();
                        if ((ifItem.onTrue.size() == 1)
                                && (ifItem.onTrue.get(0) instanceof SetMemberActionItem)
                                && (((SetMemberActionItem) ifItem.onTrue.get(0)).value
                                        instanceof NewObjectActionItem)) {
                        ...
                        if (ifItem.onTrue
                                .isEmpty()) { // if can have zero offset as the code is larger than bytes limit. TODO:
                            // make this check also for variant 2 (?)
                        ...
                        } else if (this.checkClassContent(
                                uninitializedClassTraits,
                                ifItem.onTrue,
                                variables,
                                0,
