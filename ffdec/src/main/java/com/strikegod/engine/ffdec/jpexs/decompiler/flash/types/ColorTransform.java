...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.filters.Filtering;
...
public class ColorTransform implements Cloneable {
    ...
    public RescaleOp toRescaleOp() {
        return new RescaleOp(
                new float[] {getRedMulti() / 256f, getGreenMulti() / 256f, getBlueMulti() / 256f, getAlphaMulti() / 256f
                },
    ...
    public RGB apply(RGB color) {
        ...
        return new RGBA(Filtering.colorEffect(
                color.toInt(),
                getRedAdd(),
                getGreenAdd(),
                getBlueAdd(),
    ...
    public Color apply(Color color) {
        ...
        return new Color(Filtering.colorEffect(
                color.getRGB(),
                getRedAdd(),
                getGreenAdd(),
                getBlueAdd(),
    ...
    public String toString() {
        return "[colorTransform redAdd=" + getRedAdd() + ", greenAdd=" + getGreenAdd() + ", blueAdd=" + getBlueAdd()
                + ", alphaAdd=" + getAlphaAdd() + ", redMulti=" + getRedMulti() + ", greenMulti=" + getGreenMulti()
                + ", blueMulti=" + getBlueMulti() + ", alphaMulti=" + getAlphaMulti() + "]";
    }
