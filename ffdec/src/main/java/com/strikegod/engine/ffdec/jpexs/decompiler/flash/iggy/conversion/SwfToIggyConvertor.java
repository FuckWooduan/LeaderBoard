...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.iggy.IggyCharIndices;
...
public class SwfToIggyConvertor {
    ...
    public static void updateIggy(IggySwf iggySwf, SWF swf) throws IOException {
        ...
        if (!abcTags.isEmpty()) {
            ...
            byte[] declData = Arrays.copyOfRange(
                    abcTagData,
                    4 /*UI32 flags*/ + 1 /*empty string as name*/ + 3 /*versions, leaving one zero intact*/,
                    abcTagData.length);
    ...
    public static IggyFont createIggyFont(DefineFont2Tag fontTag) {
        ...
        zeroone[12] = 1;
        long flags = 65795;
        float[] unk_float = new float[] {-0.6484375f, -1.116211f, 1.116211f, 0.6679688f, 0f};
        int xscale = 80;
        int yscale = 28;
        float ssr1 = 0.9f;
        float ssr2 = 0.3f;
        ...
        IggyFont iggyFont = new IggyFont(
                IggyFont.ID,
                0,
                zeroone,
                fontTag.getCharacterCount(),
                fontTag.getAscent(),
                fontTag.getDescent(),
                fontTag.getLeading(),
                flags,
                fontTag.fontKerningTable.size(),
                unk_float,
                0,
                what_2,
                0,
