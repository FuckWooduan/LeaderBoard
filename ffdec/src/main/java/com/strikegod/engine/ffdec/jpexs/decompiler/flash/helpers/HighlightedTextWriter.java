...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.helpers.hilight.HighlightType;
...
public class HighlightedTextWriter extends GraphTextWriter {
     ...
     */
    @Override
    public HighlightedTextWriter startOffset(
            GraphSourceItem src, GraphSourceItem startLineItem, int pos, HighlightData data) {
