...
public class CssParser {
    ...
    private void declaration(Reference<String> propName, Reference<String> propValue)
            throws IOException, CssParseException {
        CssParsedSymbol symb = lex();
    ...
    private boolean term(boolean required) throws IOException, CssParseException {
        ...
        if (symb.isType(
                CssSymbolType.NUMBER,
                CssSymbolType.PERCENTAGE,
                CssSymbolType.LENGTH,
                CssSymbolType.EMS,
                CssSymbolType.EXS,
                CssSymbolType.ANGLE,
                CssSymbolType.TIME,
