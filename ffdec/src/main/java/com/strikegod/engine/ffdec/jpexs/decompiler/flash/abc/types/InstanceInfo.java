...
public class InstanceInfo {
     ...
     * @return Writer
     */
    public GraphTextWriter getClassHeaderStr(
        ...
        if (allowEmbed) {
            if (abc.getSwf() != null) {
                String className = getName(abc.constants)
                ...
                if (ct != null) {
                    ...
                    if (Configuration.as3ExportNamesUseClassNamesOnly.get()) {
                        if (Configuration.autoDeobfuscateIdentifiers.get()) {
                            fileName = getName(abc.constants)
                                    .getNameWithNamespace(usedDeobfuscations, abc, abc.constants, false)
                    ...
                    if (ct instanceof DefineBinaryDataTag) {
                        writer.appendNoHilight("[Embed(source=\"" + ASSETS_DIR + fileName
                    ...
                    if (ct instanceof DefineSpriteTag) {
                        writer.appendNoHilight("[Embed(source=\"" + ASSETS_DIR + "assets.swf\", symbol=\"" + "symbol"
                                        + ct.getCharacterId() + "\")]")
                                .newLine();
                    }
                    if (ct instanceof DefineSoundTag) {
                        ...
                        if (st.getSoundFormat().formatId == SoundFormat.FORMAT_MP3) {
                            ...
                            writer.appendNoHilight("[Embed(source=\"" + ASSETS_DIR + "assets.swf\", symbol=\""
                                            + "symbol" + ct.getCharacterId() + "\")]")
                                    .newLine();
                        }
                    }
                    if (ct instanceof FontTag) {
                        ...
                        List<CharacterIdTag> sameIdTags =
                                ft.getSwf().getCharacterIdTags(abc.getSwf().getCharacterId(ft));
                        ...
                        writer.appendNoHilight(
                                        "fontName=\"" + Helper.escapeActionScriptString(ft.getFontNameIntag()) + "\",")
                                .newLine();
                        writer.appendNoHilight(
                                        "fontFamily=\"" + Helper.escapeActionScriptString(ft.getFontName()) + "\",")
                                .newLine();
                        writer.appendNoHilight("mimeType=\"application/x-font\",")
                                .newLine();
                        writer.appendNoHilight("fontWeight=\"" + (ft.isBold() ? "bold" : "normal") + "\",")
                                .newLine();
                        writer.appendNoHilight("fontStyle=\"" + (ft.isItalic() ? "italic" : "normal") + "\",")
                                .newLine();
                        ...
                        if (!fontChars.isEmpty()) {
                            ...
                            writer.appendNoHilight("unicodeRange=\"")
                                    .appendNoHilight(sb.toString())
                                    .appendNoHilight("\",")
                                    .newLine();
                        }
                        writer.appendNoHilight(
                                        "advancedAntiAliasing=\"" + (hasFontAlignZones ? "true" : "false") + "\",")
                                .newLine();
                    ...
                    if (ct instanceof DefineFont4Tag) {
                        ...
                        writer.appendNoHilight("[Embed(source=\"" + ASSETS_DIR + fileName + "\",")
                                .newLine();
                        writer.appendNoHilight("fontName=\"" + Helper.escapeActionScriptString(ft4.fontName) + "\",")
                                .newLine();
                        writer.appendNoHilight("mimeType=\"application/x-font\",")
                                .newLine();
                        writer.appendNoHilight("fontWeight=\"" + (ft4.fontFlagsBold ? "bold" : "normal") + "\",")
                                .newLine();
                        writer.appendNoHilight("fontStyle=\"" + (ft4.fontFlagsItalic ? "italic" : "normal") + "\",")
                                .newLine();
        ...
        String classTypeName = abc.constants
        ...
        writer.hilightSpecial(
                abc.constants
                        .getMultiname(name_index)
                        .getName(usedDeobfuscations, abc, abc.constants, null /* No full names here*/, false, true),
        ...
        if (super_index > 0) {
            String typeName = abc.constants
                    .getMultiname(super_index)
                    .getNameWithNamespace(usedDeobfuscations, abc, abc.constants, true)
                    .toRawString();
            String parentName = abc.constants
                    .getMultiname(super_index)
