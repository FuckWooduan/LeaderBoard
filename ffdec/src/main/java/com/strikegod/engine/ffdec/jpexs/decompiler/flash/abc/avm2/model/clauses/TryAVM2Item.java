...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.abc.avm2.parser.script.AssignableAVM2Item;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.abc.avm2.parser.script.NameAVM2Item;
...
public class TryAVM2Item extends AVM2Item implements Block {
    ...
    public GraphTextWriter appendTo(GraphTextWriter writer, LocalData localData) throws InterruptedException {
        ...
        for (int e = 0; e < catchExceptions.size(); e++) {
            writer.newLine();
            writer.append("catch(");
            String localName = catchExceptions
                    .get(e)
                    .getVarName(
            ...
            data.declaredType = eti <= 0
                    ? DottedChain.ALL
                    : localData
                            .constantsAvm2
                            .getMultiname(eti)
                            .getNameWithNamespace(
                                    localData.usedDeobfuscations, localData.abc, localData.constantsAvm2, true);
