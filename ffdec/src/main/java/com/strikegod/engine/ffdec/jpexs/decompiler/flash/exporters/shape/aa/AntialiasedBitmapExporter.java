package com.strikegod.engine.ffdec.jpexs.decompiler.flash.exporters.shape.aa;
...
public class AntialiasedBitmapExporter extends BitmapExporter {
    ...
    public static void export(
            ...
            int aaScale) {
        AntialiasedBitmapExporter exporter = new AntialiasedBitmapExporter(
                windingRule, shapeNum, swf, shape, defaultColor, colorTransform, (int) Math.round(20 / unzoom));
    ...
    protected AntialiasedBitmapExporter(
            int windingRule,
            int shapeNum,
            SWF swf,
            SHAPE shape,
            ...
            for (int x = 0; x < cx; x++) {
                ...
                if (clip != null) {
                    ...
                    t.preConcatenate(AffineTransform.getTranslateInstance(
                            -shapeViewRect.xMin - tileSize * x, -shapeViewRect.yMin - tileSize * y));
                ...
                graphics.drawImage(
                        image2, (int) shapeViewRect.xMin + tileSize * x, (int) shapeViewRect.yMin + tileSize * y, null);
            }
        }
    ...
    public void curveTo(double controlX, double controlY, double anchorX, double anchorY) {
        ...
        AntialiasTools.append(
                contour, AntialiasTools.flattenQuadraticBezier(lastPos, controlVec2, anchorVec2, curveFlatness), true);
        lastPos = anchorVec2;
    }
    ...
    protected void finalizePath() {
        if (fillPaint != null) {
            if (fillPaint instanceof MultipleGradientPaint) {
                ...
                if (fillRepeat) {
                    rz.fillContoursWithPaint(
                            contours, Path2D.WIND_EVEN_ODD, fillPaint, fillTransform, fillSmooth, null);
                } else {
