 ...
 */
package com.strikegod.engine.ffdec.jpexs.decompiler.flash.tags.font;
...
public class CharacterRanges {
    ...
    static {
        BufferedReader br = new BufferedReader(new InputStreamReader(CharacterRanges.class.getResourceAsStream(
                "/com/strikegod/engine/ffdec/jpexs/decompiler/flash/tags/font/character_ranges.txt")));
        String s;
        try {
            ...
            Logger.getLogger(CharacterRanges.class.getName())
                    .log(Level.SEVERE, "Cannot read unicode character ranges", ex);
        }
    }
}
