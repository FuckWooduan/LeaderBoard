...
public final class XmlLexer {
    ...
    private static final String ZZ_CMAP_PACKED =
            "\11\0\1\1\1\3\1\33\1\33\1\2\22\0\1\1\1\7\1\26" + "\1\31\2\0\1\4\1\27\5\0\1\10\1\13\1\24\12\14\1\11"
    ...
    private static final String ZZ_ACTION_PACKED_0 =
            "\5\0\1\1\4\2\1\0\2\2\1\0\1\2\1\3" + "\1\4\5\2\3\0\1\5\7\0\1\6\1\7\1\0"
    ...
    private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\34\0\70\0\124\0\160\0\214\0\250\0\304"
    ...
    private static final String ZZ_TRANS_PACKED_0 =
            "\4\6\1\7\1\10\1\11\25\6\2\12\1\13\5\12" + "\1\14\22\12\1\13\2\15\1\16\20\15\1\17\7\15"
    ...
    private static final String ZZ_ATTRIBUTE_PACKED_0 =
            "\5\0\2\1\1\11\2\1\1\0\2\1\1\0\2\1" + "\1\11\5\1\3\0\1\1\7\0\2\11\1\0\1\11"
        ...
        while (true) {
            ...
            switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
                ...
                case 24:
                    break;
                case 6: {
                    return new XmlParsedSymbol(
                            XmlSymbolType.ATTRIBUTE,
                            yytext().substring(0, yytext().length() - 1).trim(),
                            yytext(),
                            yychar);
                }
                case 25:
                ...
                case 10: {
                    return new XmlParsedSymbol(
                            XmlSymbolType.ENTITY, yytext().substring(1, yytext().length() - 1), yytext(), yychar);
                }
                case 29:
                    break;
                case 11: {
                ...
                case 14: {
                    return new XmlParsedSymbol(
                            XmlSymbolType.ENTITY_NUMERIC,
                            Integer.parseInt(yytext().substring(1, yytext().length() - 1)),
                            yytext(),
                            yychar);
                }
                case 33:
                ...
                case 16: {
                    return new XmlParsedSymbol(
                            XmlSymbolType.TAG_CLOSE, yytext().substring(2, yytext().length() - 1), yytext(), yychar);
                }
                case 35:
                    break;
                case 17: {
                    yypushback(3);
                    return new XmlParsedSymbol(
                            XmlSymbolType.COMMENT,
                            yytext().substring(yytext().length() - 3),
                            yytext().substring(yytext().length() - 3),
                            yychar);
                }
                case 36:
