...
public class Filtering {
    ...
    private static void boxBlurSingleIterationTwoPass(
            int[] pixels, int[] newColors, int w, int h, int radiusX, int radiusY) {
    ...
    public static SerializableImage bevel(
            ...
            int iterations) {
        return new SerializableImage(gradientBevel(
                ...
                new float[] {0, 127f / 255f, 128f / 255f, 1},
                blurX,
                blurY,
                strength,
                type,
    ...
    public static SerializableImage gradientBevel(
            SerializableImage src,
            Color[] colors,
            float[] ratios,
            int blurX,
    ...
    private static BufferedImage gradientBevel(
            BufferedImage src,
            Color[] colors,
            float[] ratios,
            int blurX,
        ...
        BufferedImage hilightImInner =
                dropShadow(src, 0, 0, angle, distance, Color.red, true, iterations, strength, true, true);
        BufferedImage shadowImInner =
                dropShadow(src, 0, 0, angle + 180, distance, Color.blue, true, iterations, strength, true, true);
        ...
        BufferedImage hilightImOuter =
                dropShadow(src, 0, 0, angle + 180, distance, Color.red, false, iterations, strength, true, true);
        BufferedImage shadowImOuter =
                dropShadow(src, 0, 0, angle, distance, Color.blue, false, iterations, strength, true, true);
    ...
    public static SerializableImage glow(
            SerializableImage src,
            int blurX,
            int blurY,
            float strength,
            ...
            boolean knockout,
            int iterations) {
        return new SerializableImage(dropShadow(
                src.getBufferedImage(), blurX, blurY, 45, 0, color, inner, iterations, strength, knockout, true));
    }

    private static Color over(Color a, Color b) {
        int resultA = a.getAlpha() + b.getAlpha() * (255 - a.getAlpha()) / 255;
        int resultR = cut((a.getRed() * (a.getAlpha() / 255.0)
                        + b.getRed() * (b.getAlpha() / 255.0) * (1 - (a.getAlpha() / 255.0)))
                / (resultA / 255.0));
        int resultG = cut((a.getGreen() * (a.getAlpha() / 255.0)
                        + b.getGreen() * (b.getAlpha() / 255.0) * (1 - (a.getAlpha() / 255.0)))
                / (resultA / 255.0));
        int resultB = cut((a.getBlue() * (a.getAlpha() / 255.0)
                        + b.getBlue() * (b.getAlpha() / 255.0) * (1 - (a.getAlpha() / 255.0)))
                / (resultA / 255.0));
        return new Color(resultR, resultG, resultB, resultA);
    }

    public static SerializableImage dropShadow(
            SerializableImage src,
            int blurX,
            int blurY,
            float angle,
    ...
    private static BufferedImage dropShadow(
            BufferedImage src,
            int blurX,
            int blurY,
            float angle,
        ...
        for (int i = 0; i < srcPixels.length; i++) {
            ...
            Color shadowColor =
                    new Color(color.getRed(), color.getGreen(), color.getBlue(), cut(color.getAlpha() * alpha / 255f));
    ...
    public static SerializableImage gradientGlow(
            SerializableImage src,
            int blurX,
            int blurY,
            float angle,
            ...
            boolean knockout,
            boolean compositeSource) {
        return new SerializableImage(gradientGlow(
                src.getBufferedImage(),
                blurX,
                blurY,
                angle,
    ...
    private static BufferedImage gradientGlow(
            BufferedImage src,
            int blurX,
            int blurY,
            float angle,
    ...
    public static SerializableImage colorEffect(
            SerializableImage src,
            int redAddTerm,
            int greenAddTerm,
            int blueAddTerm,
