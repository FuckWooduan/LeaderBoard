 ...
 */
package com.strikegod.engine.ffdec.jpexs.decompiler.flash.abc.avm2.instructions.construction;
...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.abc.avm2.model.XMLAVM2Item;
    ...
    public void translate(
        ...
        if (obj instanceof GetPropertyAVM2Item) {
            ...
            if (gpt.object instanceof FindPropertyAVM2Item) {
                ...
                isRegExp = fptRegExpMult.isTopLevel(
                                "RegExp",
                                localData.abc,
                                localData.localRegNames,
                                localData.fullyQualifiedNames,
                                localData.seenMethods)
                        && gptRegExpMult.isTopLevel(
                                "RegExp",
                                localData.abc,
                                localData.localRegNames,
                                localData.fullyQualifiedNames,
        ...
        if (isRegExp
                && (args.size() >= 1)
                && (args.get(0) instanceof StringAVM2Item)
