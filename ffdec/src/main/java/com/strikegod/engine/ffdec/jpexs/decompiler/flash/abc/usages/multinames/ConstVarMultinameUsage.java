 ...
 */
package com.strikegod.engine.ffdec.jpexs.decompiler.flash.abc.usages.multinames;
    ...
    public String toString() {
        ...
        if (parentTraitIndex > -1) {
            if (traitsType == TRAITS_TYPE_CLASS) {
                ((TraitMethodGetterSetter) abc.class_info
                                .get(classIndex)
                                .static_traits
                                .traits
                                .get(parentTraitIndex))
                        .convertHeader(
                                new LinkedHashSet<>(),
                                -1,
                                null,
        ...
        try {
            ((TraitSlotConst) traits.traits.get(traitIndex))
                    .convertHeader(
                            new LinkedHashSet<>(),
                            -1,
                            null,
