...
public class IggyShapeNode implements StructureInterface {
    ...
    @IggyFieldType(DataType.uint8_t) // 208 start smooth (for j=1 only), 61 smooth interrupt (muze a nemusi byt pro novy
    // oddeleny kus charu - kdyz je subtype predchoziho vetsi nez 0 (kupr 5) bude pro oddeleny
    // usek 61, jinak pokud je subtype predchoziho 0 bude pro oddeleny usek 0)
    int node_subtype;
