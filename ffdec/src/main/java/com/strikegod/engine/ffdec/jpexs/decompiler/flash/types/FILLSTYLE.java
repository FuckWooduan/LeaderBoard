...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.annotations.ConditionalType;
...
public class FILLSTYLE implements NeedsCharacters, FieldChangeObserver, Serializable {
    ...
    @ConditionalType(
            type = RGBA.class,
            tags = {DefineShape3Tag.ID, DefineShape4Tag.ID})
    public RGB color;
    ...
    @Conditional(
            value = "fillStyleType",
            options = {LINEAR_GRADIENT, RADIAL_GRADIENT, FOCAL_RADIAL_GRADIENT})
    ...
    @ConditionalType(
            value = "fillStyleType",
            type = FOCALGRADIENT.class,
            options = {FOCAL_RADIAL_GRADIENT})
    ...
    @Conditional(
            value = "fillStyleType",
            options = {REPEATING_BITMAP, CLIPPED_BITMAP, NON_SMOOTHED_REPEATING_BITMAP, NON_SMOOTHED_CLIPPED_BITMAP})
    public int bitmapId;
    ...
    public void fieldChanged(Field field) {
        if ((fillStyleType == FILLSTYLE.LINEAR_GRADIENT) || (fillStyleType == FILLSTYLE.RADIAL_GRADIENT)) {
