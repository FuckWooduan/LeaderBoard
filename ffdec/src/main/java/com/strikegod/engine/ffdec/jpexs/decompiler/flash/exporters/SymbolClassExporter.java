...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.exporters.settings.SymbolClassExportSettings;
...
public class SymbolClassExporter {
    ...
    public List<File> exportNames(
            AbortRetryIgnoreHandler handler,
            final String outdir,
            ReadOnlyTagList tags,
            SymbolClassExportSettings settings,
            EventListener evl)
