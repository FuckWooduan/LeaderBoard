 ...
 */
package com.strikegod.engine.ffdec.jpexs.decompiler.flash.types.text.format;
...
public class ControlTextFormatRecord implements TextFormatRecord {
    ...
    @Conditional(
            value = "type",
            options = {TYPE_FONT_ID})
    @SWFType(BasicType.UI16)
    public int fontId;

    @Conditional(
            value = "type",
            options = {TYPE_FONT_HEIGHT})
    @SWFType(BasicType.UI16)
    ...
    @Conditional(
            value = "type",
            options = {TYPE_LEFT_MARGIN})
    @SWFType(BasicType.SI16)
    public int leftMargin;

    @Conditional(
            value = "type",
            options = {TYPE_RIGHT_MARGIN})
    @SWFType(BasicType.SI16)
    public int rightMargin;

    @Conditional(
            value = "type",
            options = {TYPE_LINE_SPACE})
    @SWFType(BasicType.SI16)
