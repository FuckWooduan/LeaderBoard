...
public class ClassActionItem extends ActionItem implements Block {
     ...
     */
    public ClassActionItem(
            GraphTargetItem className,
            GraphTargetItem extendsOp,
            List<GraphTargetItem> implementsOp,
            ...
            for (int i = 0; i < traits.size(); i++) {
                ...
                if (item.getValue() instanceof FunctionActionItem) {
                    ...
                    writer.append(IdentifiersDeobfuscation.printIdentifier(
                            ...
                            false,
                            item.getKey().toStringNoQuotes(localData)));
    ...
    public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData, SourceGenerator generator)
        ...
        ret.addAll(asGenerator.generateTraits(
                localData2, false, className, extendsOp, implementsOp, traits, traitsStatic));
        return ret;
    }
