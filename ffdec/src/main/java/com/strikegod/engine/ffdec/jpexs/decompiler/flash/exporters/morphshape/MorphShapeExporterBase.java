...
public abstract class MorphShapeExporterBase implements IMorphShapeExporter {
    ...
    public void export() {
        ...
        createEdgeMaps(
                morphShapeNum, _fillStyles, _lineStyles, _fillStylesEnd, _lineStylesEnd, _fillEdgeMaps, _lineEdgeMaps);
    ...
    protected void createEdgeMaps(
            ...
            List<FILLSTYLE> fillStylesEnd,
            List<ILINESTYLE> lineStylesEnd,
            List<Map<Integer, List<IMorphEdge>>> fillEdgeMaps,
            List<Map<Integer, List<IMorphEdge>>> lineEdgeMaps) {
        if (!edgeMapsCreated) {
            int xPos = 0;
            int yPos = 0;
            int xPosEnd = 0;
            ...
            for (int i = 0; i < records.size(); i++) {
                ...
                if ((shapeRecord instanceof StyleChangeRecord && !(shapeRecordEnd instanceof StyleChangeRecord))
                        || (shapeRecord instanceof StraightEdgeRecord
                                && !(shapeRecordEnd instanceof StraightEdgeRecord))
                ...
                if (shapeRecord instanceof StyleChangeRecord) {
                    ...
                    if (styleChangeRecord.stateLineStyle
                        ...
                        processSubPath(
                                subPath,
                                currentLineStyleIdx,
                                currentFillStyleIdx0,
                                currentFillStyleIdx1,
                                currentFillEdgeMap,
                                currentLineEdgeMap);
                    ...
                    subPath.add(new StraightMorphEdge(
                            xPosFrom,
                            yPosFrom,
                            xPos,
                            yPos,
                    ...
                    subPath.add(new CurvedMorphEdge(
                            xPosFrom,
                            yPosFrom,
                            xPosControl,
                            yPosControl,
    ...
    protected void processSubPath(
            List<IMorphEdge> subPath,
            int lineStyleIdx,
            int fillStyleIdx0,
            int fillStyleIdx1,
            Map<Integer, List<IMorphEdge>> currentFillEdgeMap,
            Map<Integer, List<IMorphEdge>> currentLineEdgeMap) {
                        ...
                        switch (fillStyle.fillStyleType) {
                            case FILLSTYLE.SOLID:
                                ...
                                if (colorTransform == null) {
                                    ...
                                    beginFill(
                                            colorTransform.apply(fillStyle.color),
                                            colorTransform.apply(fillStyleEnd.color));
                                }
                                break;
                            ...
                            case FILLSTYLE.FOCAL_RADIAL_GRADIENT:
                                ...
                                beginGradientFill(
                                        ...
                                        (fillStyle.gradient instanceof FOCALGRADIENT)
                                                ? ((FOCALGRADIENT) fillStyle.gradient).focalPoint
                                                : 0,
                                        (fillStyleEnd.gradient instanceof FOCALGRADIENT)
                                                ? ((FOCALGRADIENT) fillStyleEnd.gradient).focalPoint
                                                : 0);
                                break;
                ...
                if (lineStyleIdx != e.getLineStyleIdx()) {
                    ...
                    if (lineStyle != null) {
                        ...
                        lineStyle(
                                ...
                                colorTransform == null
                                        ? lineStyle.getColor()
                                        : colorTransform.apply(lineStyle.getColor()),
                                colorTransform == null
                                        ? lineStyleEnd.getColor()
                                        : colorTransform.apply(lineStyleEnd.getColor()),
                                pixelHintingFlag,
                                scaleMode,
                                startCapStyle,
                                endCapStyle,
                ...
                while (subPath.size() > 0) {
                    ...
                    while (idx < subPath.size()) {
                        if (prevEdge != null) {
                            ...
                            if (prevEdge.getToX() != subPathEdge.getFromX()
                                    || prevEdge.getToY() != subPathEdge.getFromY()) {
