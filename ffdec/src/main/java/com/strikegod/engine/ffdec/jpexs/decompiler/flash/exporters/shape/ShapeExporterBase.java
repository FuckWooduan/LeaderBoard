...
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.exporters.commonshape.FillStyle;
import com.strikegod.engine.ffdec.jpexs.decompiler.flash.exporters.commonshape.LineStyle;
...
public abstract class ShapeExporterBase implements IShapeExporter {
    ...
    private void createEdgeMaps(
            ...
            List<Map<Integer, List<IEdge>>> fillEdgeMaps,
            List<Map<Integer, List<IEdge>>> lineEdgeMaps) {
        int xPos = 0;
        int yPos = 0;
        ...
        for (int i = 0; i < records.size(); i++) {
            ...
            if (shapeRecord instanceof StyleChangeRecord) {
                ...
                subPath.add(
                        new StraightEdge(xPosFrom, yPosFrom, xPos, yPos, currentLineStyleIdx, currentFillStyleIdx1));
    ...
    private void processSubPath(
            List<IEdge> subPath,
            int lineStyleIdx,
            int fillStyleIdx0,
            int fillStyleIdx1,
            Map<Integer, List<IEdge>> currentFillEdgeMap,
            Map<Integer, List<IEdge>> currentLineEdgeMap) {
        List<IEdge> path;
        if (fillStyleIdx0 != 0) {
