...
public class GraphPart implements Serializable {
     ...
     */
    private boolean leadsTo(
            BaseLocalData localData,
            Graph gr,
            GraphSource code,
            GraphPart prev,
            GraphPart part,
            HashSet<GraphPart> visited,
            List<Loop> loops,
            List<ThrowState> throwStates,
            boolean firstCanBeLoopContinue)
    ...
    public boolean leadsTo(
        ...
        return leadsTo(
                localData, gr, code, null /*???*/, part, new HashSet<>(), loops, throwStates, firstCanBeLoopContinue);
