...
public class FontHelper {
    ...
    public static int getFontCharsKerning(Font font, char char1, char char2) {
        ...
        GlyphVector withKerningVector = withKerningFont.layoutGlyphVector(
                getFontRenderContext(withKerningFont), chars, 0, chars.length, Font.LAYOUT_LEFT_TO_RIGHT);
        ...
        GlyphVector noKerningVector = noKerningFont.layoutGlyphVector(
                getFontRenderContext(noKerningFont), chars, 0, chars.length, Font.LAYOUT_LEFT_TO_RIGHT);
    ...
    private static List<File> getTtfFilesRecursively(File dir) {
        ...
        try {
            ...
            for (File f : files) {
                ...
                } else if (f.getAbsolutePath().endsWith(".ttf")
                        || f.getAbsolutePath().endsWith(".TTF")) {
                    ret.add(f);
                }
            }
        } catch (Exception ex) {
